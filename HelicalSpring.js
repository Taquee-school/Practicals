...
let helicalSpringDiv = document.createElement("div");
helicalSpringDiv.className = "practical-file";

let hls_objectiveDiv = document.createElement("div");
helicalSpringDiv.appendChild(hls_objectiveDiv);
hls_objectiveDiv.className = "practical-section";
...
let hls_apparatusDiv = document.createElement("div");
helicalSpringDiv.appendChild(hls_apparatusDiv);
hls_apparatusDiv.className = "practical-section";
...
let hls_formulaDiv = document.createElement("div");
helicalSpringDiv.appendChild(hls_formulaDiv);
hls_formulaDiv.className = "practical-section";
...
let hls_formulaBelonging = document.createElement("div");
hls_formulaDiv.appendChild(hls_formulaBelonging);
hls_formulaBelonging.className = "moved-div";

hls_formulaBelonging.appendChild(createTextField("", ""));

let hls_observationDiv = document.createElement("div");
helicalSpringDiv.appendChild(hls_observationDiv);
hls_observationDiv.className = "practical-section";
...
let hls_zeroErrorDiv = document.createElement("div");
hls_observationDiv.appendChild(hls_zeroErrorDiv);
hls_zeroErrorDiv.className = "moved-div";
...
let hls_diameterTableDiv = document.createElement("div");
hls_diameterTableDiv.className = "observation-table-div";
hls_observationDiv.appendChild(hls_diameterTableDiv);

let hls_diameterTable = document.createElement("div");
hls_diameterTable.className = "observation-table";
...
let hls_resultDiv = document.createElement("div");
helicalSpringDiv.appendChild(hls_resultDiv);
hls_resultDiv.className = "practical-section";
...
let hls_precautionsDiv = document.createElement("div");
helicalSpringDiv.appendChild(hls_precautionsDiv);
hls_precautionsDiv.className = "practical-section";
