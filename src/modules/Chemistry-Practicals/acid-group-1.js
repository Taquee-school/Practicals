...
ag1_reagentDiv.appendChild(
  createTextField("practical-section-text", "Reagent: "),
);
ag1_reagentDiv.appendChild(
  createTextField("practical-section-value", "Dil. H2SO4"),
);

// #region Carbonate Table
experimentDiv.appendChild(
  createTextField("observation-table-header", "Carbonate"),
);
...
ag1_carbonateExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add 1-2ml dil. H2SO4.",
  ),
);
...
ag1_carbonateExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Take a pinch of salt in another dry test tube, add 1-2ml dil. H2SO4 and pass the evolved gas through lime water with the help of a delivery tube.",
  ),
);
...
ag1_carbonateObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Evolution of colorless and odorless gas with effervescence",
  ),
);
...
ag1_carbonateObservation2Div.appendChild(
  createTextField("observation-table-text", "Lime water turns milky"),
);
...
ag1_carbonateInference1Div.appendChild(
  createTextField("observation-table-text", "May be CO3"),
);
...
ag1_carbonateInference2Div.appendChild(
  createTextField("observation-table-text", "CO3 Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(
  createTextField("observation-table-header", "Sulphide"),
);
...
ag1_sulphideExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add 1-2ml dil. H2SO4.",
  ),
...
ag1_sulphideExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Take aqueous solution and add sodium nitropasside solution.",
  ),
);
// #endregion Experiment
...
ag1_sulphideObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Evolution of gas with a smell of rotten egg.",
  ),
);
...
ag1_sulphideObservation2Div.appendChild(
  createTextField("observation-table-text", "Purple coloration"),
);
// #endregion Observation
...
ag1_sulphideInference1Div.appendChild(
  createTextField("observation-table-text", "May be S2"),
);
...
ag1_sulphideInference2Div.appendChild(
  createTextField("observation-table-text", "S2 Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(
  createTextField("observation-table-header", "Sulphite"),
);
...
ag1_sulphiteExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add 1-2ml dil. H2SO4.",
  ),
...
ag1_sulphiteExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Take a pinch of salt in another dry test tube and add dil. H2SO4 and bring a paper dipped in acidified potassium dichromate solution.",
  ),
);
// #endregion Experiment
...
ag1_sulphiteObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Evolution of gas with a smell of burning sulphur.",
  ),
);
...
ag1_sulphiteObservation2Div.appendChild(
  createTextField("observation-table-text", "Paper turns green"),
);
// #endregion Observation
...
ag1_sulphiteInference1Div.appendChild(
  createTextField("observation-table-text", "May be SO3"),
);
...
ag1_sulphiteInference2Div.appendChild(
  createTextField("observation-table-text", "SO3 Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(
  createTextField("observation-table-header", "Nitrate"),
);
...
ag1_nitrateExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add 1-2ml dil. H2SO4.",
  ),
...
ag1_nitrateExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Prepare salt solution, add thiourea and FeCl2.",
  ),
);
// #endregion Experiment
...
ag1_nitrateObservation1Div.appendChild(
  createTextField("observation-table-text", "Evolution of brown colour gas."),
);
...
ag1_nitrateObservation2Div.appendChild(
  createTextField("observation-table-text", "Blood red coloration."),
);
// #endregion Observation
...
ag1_nitrateInference1Div.appendChild(
  createTextField("observation-table-text", "May be NO2"),
);
...
ag1_nitrateInference2Div.appendChild(
  createTextField("observation-table-text", "NO2 Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(
  createTextField("observation-table-header", "Acetate"),
);
...
ag1_acetateExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add 1-2ml dil. H2SO4.",
  ),
...
ag1_acetateExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Prepare aqueous solution of salt and add FeCl2 solution.",
  ),
);
// #endregion Experiment
...
ag1_acetateObservation1Div.appendChild(
  createTextField("observation-table-text", "Smell of vinegar"),
);
...
ag1_acetateObservation2Div.appendChild(
  createTextField("observation-table-text", "Blood red coloration."),
);
// #endregion Observation
...
ag1_acetateInference1Div.appendChild(
  createTextField("observation-table-text", "May be CH3COO"),
);
...
ag1_acetateInference2Div.appendChild(
  createTextField("observation-table-text", "CH3COO Confirmed"),
);
// #endregion Inference
