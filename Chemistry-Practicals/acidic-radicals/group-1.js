let acidicGroup1Div = createDiv("practical-file", "chemistry-practical");

let ag1_reagentDiv = createDiv("practical-section-text-div");
acidicGroup1Div.appendChild(ag1_reagentDiv);
...
acidicGroup1Div.appendChild(createTextField("observation-table-header", "Carbonate"));

let ag1_carbonateTable = createDiv("observation-table");
acidicGroup1Div.appendChild(ag1_carbonateTable);
...
acidicGroup1Div.appendChild(createTextField("observation-table-header", "Sulphide"));

let ag1_sulphideTable = createDiv("observation-table");
acidicGroup1Div.appendChild(ag1_sulphideTable);
...
acidicGroup1Div.appendChild(createTextField("observation-table-header", "Sulphite"));

let ag1_sulphiteTable = createDiv("observation-table");
acidicGroup1Div.appendChild(ag1_sulphiteTable);
...
acidicGroup1Div.appendChild(createTextField("observation-table-header", "Nitrate"));

let ag1_nitrateTable = createDiv("observation-table");
acidicGroup1Div.appendChild(ag1_nitrateTable);
...
acidicGroup1Div.appendChild(createTextField("observation-table-header", "Acetate"));

let ag1_acetateTable = createDiv("observation-table");
acidicGroup1Div.appendChild(ag1_acetateTable);
