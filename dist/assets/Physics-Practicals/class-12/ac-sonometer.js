import { createDiv, createInput, createTextField, createImg, physicsFilePath_class12, createTableColumn, toggleEffect, createButton, createIcon, createInputDiv, createPAS } from "../../../utils/practical.js";
...
experimentDiv.appendChild(acs_diagramDiv);
acs_diagramDiv.appendChild(createTextField("practical-section-header", "DIAGRAM:"));
acs_diagramDiv.appendChild(createImg("practical-file-diagram", "light", physicsFilePath_class12 + "class-12/assets/diagrams/light/ac sonometer.jpg"));
acs_diagramDiv.appendChild(createImg("practical-file-diagram", "dark", physicsFilePath_class12 + "class-12/assets/diagrams/dark/ac sonometer.jpg"));
// #endregion Diagram
// #region Objective
let acs_objectiveDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_objectiveDiv);
acs_objectiveDiv.appendChild(createTextField("practical-section-header", "OBJECT:"));
acs_objectiveDiv.appendChild(createTextField("practical-section-content", "To find the frequency of an alternating current (ac mains) by sonometer and an electromagnet."));
// #endregion Objective
// #region Apparatus
let acs_apparatusDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_apparatusDiv);
acs_apparatusDiv.appendChild(createTextField("practical-section-header", "APPARATUS USED:"));
acs_apparatusDiv.appendChild(createTextField("practical-section-content", "A sonometer with soft iron wire stretched over it, an electromagnet, a step-down transformer, slotted half kg weights, a hanger, a screw gauge, etc."));
// #endregion Apparatus
// #region Formula
let acs_formulaDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_formulaDiv);
acs_formulaDiv.appendChild(createTextField("practical-section-header", "FORMULA USED:"));
acs_formulaDiv.appendChild(createTextField("practical-section-content", "The frequency 'v' of the fundamental note of a stretched string of length 'l' and mass per unit length 'm' under tension 'T' is given by:"));
acs_formulaDiv.appendChild(createTextField("practical-main-formula", "v = √(T/m)/4l"));
acs_formulaDiv.appendChild(createTextField("practical-section-content", "Where, m, the mass per unit length, is given by:"));
acs_formulaDiv.appendChild(createTextField("practical-main-formula", "m = (πD²¶)/4"));
acs_formulaDiv.appendChild(createTextField("practical-section-content", "Where,"));
let acs_formulaBelonging = createDiv("moved-div");
acs_formulaDiv.appendChild(acs_formulaBelonging);
acs_formulaBelonging.appendChild(createTextField("", "D is the diameter of the sonometer wire."));
acs_formulaBelonging.appendChild(createTextField("", "¶ is its density."));
// #endregion Formula
// #region Observation
let acs_observationDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_observationDiv);
acs_observationDiv.appendChild(createTextField("practical-section-header", "OBSERVATION:"));
// #region Sonometer
acs_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of resonant length"));
...
// #endregion Sonometer
// #region Screw Gauge
acs_observationDiv.appendChild(createTextField("practical-section-content", "Measurement of diameter of wire"));
let acs_sgLeastCountInput = createInput("acs-sg-lc-input", "number", 0, measureEssentials_acs);
acs_observationDiv.appendChild(createInputDiv("Least count of screw gauge (LC) = Pitch/(no. of circular division) = ", acs_sgLeastCountInput, "mm"));
acs_observationDiv.appendChild(createTextField("practical-section-content", "Zero error (e):"));
let acs_zeroErrorDiv = createDiv("moved-div");
acs_observationDiv.appendChild(acs_zeroErrorDiv);
let acs_ze1Input = createInput("acs-zero-error-1-input", "number", 0, measureEssentials_acs);
acs_zeroErrorDiv.appendChild(createPAS("a", createInputDiv("Zero Error: ", acs_ze1Input), true));
let acs_ze2Input = createInput("acs-zero-error-2-input", "number", 0, measureEssentials_acs);
acs_zeroErrorDiv.appendChild(createPAS("b", createInputDiv("Zero Error: ", acs_ze2Input), true));
let acs_ze3Input = createInput("acs-zero-error-3-input", "number", 0, measureEssentials_acs);
acs_zeroErrorDiv.appendChild(createPAS("c", createInputDiv("Zero Error: ", acs_ze3Input), true));
let acs_meanZeroErrorInput = createInput("acs-sg-mean-ze-input", "number", 0, null, true);
acs_observationDiv.appendChild(createInputDiv("Mean zero error = ", acs_meanZeroErrorInput, ""));
let acs_zeroCorrectionInput = createInput("acs-sg-zc-input", "number", 0, null, true);
acs_observationDiv.appendChild(createInputDiv("Zero correction = ", acs_zeroCorrectionInput, ""));
let acs_densityInput = createInput("acs-sg-lc-input", "number", 7850, measureEssentials_acs);
acs_observationDiv.appendChild(createInputDiv("Density of the wire:", acs_densityInput, "kg/m³"));
acs_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of diameter of wire"));
...
let acs_meanDiameterInput = createInput("acs-sg-mean-d-input", "number", 0, null, true);
acs_observationDiv.appendChild(createInputDiv("Mean diameter = ", acs_meanDiameterInput, "cm"));
let acs_correctedDiameterInput = createInput("acs-sg-mean-corr-d-input", "number", 0, null, true);
acs_observationDiv.appendChild(createInputDiv("Mean corrected diameter = ", acs_correctedDiameterInput, "cm"));
let acs_masspulInput = createInput("acs-wire-mass-input", "number", 0, null, true);
acs_observationDiv.appendChild(createInputDiv("Mass per unit length of the wire (m) = ", acs_masspulInput, "kg/m"));
// #endregion Screw Gauge
// #endregion Observation
// #region Result
let acs_resultDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_resultDiv);
acs_resultDiv.appendChild(createTextField("practical-section-header", "RESULT:"));
let acs_meanFrequencyInput = createInput("acs-final-freq-input", "number", 0, null, true);
acs_resultDiv.appendChild(createPAS("1", createInputDiv("The frequency of a.c. mains as determined by sonometer and an electromagnet is found to be: ", acs_meanFrequencyInput, "Hz"), true));
// #endregion Result
// #region Precautions
let acs_precautionsDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_precautionsDiv);
acs_precautionsDiv.appendChild(createTextField("practical-section-header", "PRECAUTIONS:"));
acs_precautionsDiv.appendChild(createPAS("1", "The sonometer wire should be of magnetic material, free from the kinks and strecthed horizontally."));
acs_precautionsDiv.appendChild(createPAS("2", "The pole of the electromagnet should be held quite close to the middle of the vibrating segment."));
acs_precautionsDiv.appendChild(createPAS("3", "The resonant length should be observed at least twice for each load."));
acs_precautionsDiv.appendChild(createPAS("4", "While finding the resonant length, start with a small distance between the wedges."));
acs_precautionsDiv.appendChild(createPAS("5", "The weight of the hanger should also be counted while calculating the tension on the string."));
// #endregion Precautions
// #region Sources of Errors
let acs_soeDiv = createDiv("practical-section");
experimentDiv.appendChild(acs_soeDiv);
acs_soeDiv.appendChild(createTextField("practical-section-header", "SOURCES OF ERRORS:"));
acs_soeDiv.appendChild(createPAS("1", "The wire may not be of uniform area of cross section. Its composition may not be uniform."));
acs_soeDiv.appendChild(createPAS("2", "Some friction might be present at the pulley and hence the tension is less than that actually applied."));
// #endregion sources of errors
//# sourceMappingURL=ac-sonometer.js.map