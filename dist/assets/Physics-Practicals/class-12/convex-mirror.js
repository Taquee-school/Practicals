...
cvm_objectiveDiv.appendChild(createTextField("practical-section-header", "OBJECT:"));
cvm_objectiveDiv.appendChild(createTextField("practical-section-content", "To find the focal length of convex mirror using convex lens."));
// #endregion Objective
// #region Apparatus
let cvm_apparatusDiv = createDiv("practical-section");
experimentDiv.appendChild(cvm_apparatusDiv);
cvm_apparatusDiv.appendChild(createTextField("practical-section-header", "APPARATUS USED:"));
cvm_apparatusDiv.appendChild(createTextField("practical-section-content", "An optical bench along with four uprights, convex mirror, a convex lens, a knitting needle and a half meter scale."));
// #endregion Apparatus
// #region Formula
let cvm_formulaDiv = createDiv("practical-section");
experimentDiv.appendChild(cvm_formulaDiv);
cvm_formulaDiv.appendChild(createTextField("practical-section-header", "FORMULA USED:"));
cvm_formulaDiv.appendChild(createTextField("practical-section-content", "The focal length of the convex mirror is given by"));
cvm_formulaDiv.appendChild(createTextField("practical-main-formula", "f = (radius of curvature)/2 = MI/2"));
cvm_formulaDiv.appendChild(createTextField("practical-section-content", "Where, MI is the radius of curvature of the given convex mirror."));
// #endregion Formula
// #region Observation
let cvm_observationDiv = createDiv("practical-section");
experimentDiv.appendChild(cvm_observationDiv);
cvm_observationDiv.appendChild(createTextField("practical-section-header", "OBSERVATION:"));
let cvm_lengthOfNeedleInput = createInput("cvm-length-of-knitting-needle-input", "number", 0, measureEssentials_cvm);
cvm_observationDiv.appendChild(createPAS("1", createInputDiv("Length of knitting needle (y): ", cvm_lengthOfNeedleInput, "cm."), true));
let cvm_distanceMIInput = createInput("cvm-distance-with-needle-and-MI-input", "number", 0, measureEssentials_cvm);
cvm_observationDiv.appendChild(createPAS("2", createInputDiv("Observed distance with the needle M and I' (x): ", cvm_distanceMIInput, "cm."), true));
let cvm_indexCorrectionInput = createInput("cvm-index-correction-input", "number", 0, null, true);
cvm_observationDiv.appendChild(createPAS("4", createInputDiv("Index correction between M and I = (y-x):", cvm_indexCorrectionInput, "cm."), true));
cvm_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of focal length"));
...
cvm_resultDiv.appendChild(createTextField("practical-section-header", "RESULT:"));
let cvm_fFocalLengthInput = createInput("cvm-result-focal-length-input", "number", 0, null, true);
cvm_resultDiv.appendChild(createPAS("1", createInputDiv("Focal length of the given convex mirror with the help of convex lens is found to be: ", cvm_fFocalLengthInput, "cm."), true));
// #endregion Result
// #region Precautions
let cvm_precautionsDiv = createDiv("practical-section");
experimentDiv.appendChild(cvm_precautionsDiv);
cvm_precautionsDiv.appendChild(createTextField("practical-section-header", "PRECAUTIONS:"));
...
cvm_SOEDiv.appendChild(createTextField("practical-section-header", "SOURCES OF ERRORS:"));
...
//# sourceMappingURL=convex-mirror.js.map