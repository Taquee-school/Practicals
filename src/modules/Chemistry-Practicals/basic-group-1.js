...
experimentDiv.appendChild(bg1_reagentDiv);
bg1_reagentDiv.appendChild(
...
experimentDiv.appendChild(bg1_leadTable);
...
bg1_leadExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add NaOH and heat.",
  ),
);

let bg1_leadExperiment2Div = createDiv("observation-table-inner-div");
bg1_leadExperimentDiv.appendChild(bg1_leadExperiment2Div);
bg1_leadExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Bring a filter paper dipped in HCI solution near the mouth of the test tube.",
  ),
);
...
bg1_leadObservation1Div.appendChild(
  createTextField("observation-table-text", "Smell of ammonia"),
);
...
bg1_leadObservation2Div.appendChild(
  createTextField("observation-table-text", "Formation of thick white fumes"),
);
...
bg1_inference1Div.appendChild(
  createTextField("observation-table-text", "May be NH3"),
);

let bg1_inference2Div = createDiv("observation-table-inner-div");
bg1_leadInferenceDiv.appendChild(bg1_inference2Div);
bg1_inference2Div.appendChild(
  createTextField("observation-table-text", "NH3 Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(bg1_lead2Table);
...
bg1_lead2Experiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add NaOH and heat.",
  ),
...
bg1_lead2Experiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Bring a filter paper dipped in HCI solution near the mouth of the test tube.",
  ),
...
bg1_lead2Observation1Div.appendChild(
  createTextField("observation-table-text", "Smell of ammonia"),
);
...
bg1_lead2Observation2Div.appendChild(
  createTextField("observation-table-text", "Formation of thick white fumes"),
);
// #endregion Observation
