...
experimentDiv.appendChild(bg5_reagentDiv);
bg5_reagentDiv.appendChild(
  createTextField("practical-section-text", "Reagent: "),
);
bg5_reagentDiv.appendChild(
  createTextField("practical-section-value", "NH4CI + NH4OH + (NH4)2CO3"),
);

// #region Ammonium Table
experimentDiv.appendChild(
  createTextField("observation-table-header", "Test for Ba, Sr and Ca"),
);

let bg5_ammoniumTable = createDiv("observation-table");
experimentDiv.appendChild(bg5_ammoniumTable);
...
bg5_ammoniumExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare salt solution, add NH4CI, NH4OH and (NH4)2CO3.",
  ),
);
...
bg5_ammoniumExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Dissolve the precipitate in hot acetic acid and divide in three parts.",
  ),
);
...
bg5_ammoniumExperiment3Div.appendChild(
  createTextField(
    "observation-table-text",
    "a) To the first part add K2Cr2O7.",
  ),
);
...
bg5_ammoniumExperiment4Div.appendChild(
  createTextField(
    "observation-table-text",
    "b) To the second part add (NH4)2SO4.",
  ),
);
...
bg5_ammoniumExperiment5Div.appendChild(
  createTextField(
    "observation-table-text",
    "c) To the third part add (NH4)2CO3.",
  ),
);
...
bg5_ammoniumObservation1Div.appendChild(
  createTextField("observation-table-text", "White precipitate."),
);
...
bg5_ammoniumObservation2Div.appendChild(
...
bg5_ammoniumObservation3Div.appendChild(
  createTextField("observation-table-text", "Yellow precipitate"),
);
...
bg5_ammoniumObservation4Div.appendChild(
  createTextField("observation-table-text", "White precipitate"),
);
...
bg5_ammoniumObservation5Div.appendChild(
  createTextField("observation-table-text", "White precipitate"),
);
...
bg5_ammoniumInference1Div.appendChild(
  createTextField("observation-table-text", "Group V present"),
);
...
bg5_ammoniumInference2Div.appendChild(
  createTextField("observation-table-text", ""),
);
...
bg5_ammoniumInference3Div.appendChild(
  createTextField("observation-table-text", "Ba confirmed"),
);
...
bg5_ammoniumInference4Div.appendChild(
  createTextField("observation-table-text", "Sr confirmed"),
);
...
bg5_ammoniumInference5Div.appendChild(
  createTextField("observation-table-text", "Ca confirmed"),
);
// #endregion Inference
