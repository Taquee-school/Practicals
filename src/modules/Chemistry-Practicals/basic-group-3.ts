...
experimentDiv.appendChild(bg3_reagentDiv);
bg3_reagentDiv.appendChild(
  createTextField("practical-section-text", "Reagent: "),
);
bg3_reagentDiv.appendChild(
  createTextField("practical-section-value", "NH4Cl + NH4OH"),
);

// #region aluminum Table
experimentDiv.appendChild(
  createTextField("observation-table-header", "aluminum"),
);

let bg3_aluminumTable = createDiv("observation-table");
experimentDiv.appendChild(bg3_aluminumTable);
...
bg3_aluminumExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare salt solution, add 1 ml conc. HNO3, boil to dryness, cool & add ammonium chloride and ammonium hydroxide in excess.",
  ),
);
...
bg3_aluminumExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Dissolve the precipitate by boiling in sodium hydroxide and add solid NH4Cl.",
  ),
);
...
bg3_aluminumObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Formation of white gelatinous precipitate.",
  ),
);
...
bg3_aluminumObservation2Div.appendChild(
  createTextField(
    "observation-table-text",
    "Reappearance of white gelatinous precipitate.",
  ),
);
...
bg3_aluminumInference1Div.appendChild(
  createTextField("observation-table-text", "May be Al3+"),
);
...
bg3_aluminumInference2Div.appendChild(
  createTextField("observation-table-text", "Al3+ Confirmed"),
);
// #endregion Inference
// #endregion aluminum Table

// #region iron Table
experimentDiv.appendChild(createTextField("observation-table-header", "iron"));

let bg3_ironTable = createDiv("observation-table");
experimentDiv.appendChild(bg3_ironTable);
...
bg3_ironExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare salt solution, add 1 ml conc. HNO3, boil to dryness, cool & add ammonium chloride and ammonium hydroxide in excess.",
  ),
...
bg3_ironExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Dissolve the precipitate in minimum HCI and divide in two parts.",
  ),
);

let bg3_ironExperiment3Div = createDiv("observation-table-inner-div");
bg3_ironExperimentDiv.appendChild(bg3_ironExperiment3Div);
bg3_ironExperiment3Div.appendChild(
  createTextField(
    "observation-table-text",
    "a) To the first part add K3[Fe(CN)6].",
  ),
);

let bg3_ironExperiment4Div = createDiv("observation-table-inner-div");
bg3_ironExperimentDiv.appendChild(bg3_ironExperiment4Div);
bg3_ironExperiment4Div.appendChild(
  createTextField(
    "observation-table-text",
    "b) To the second part add KSCN (potassium sulphocyanide).",
  ),
);
// #endregion Experiment
...
bg3_ironObservation1Div.appendChild(
  createTextField("observation-table-text", "Formation of brown precipitate."),
);
...
bg3_ironObservation2Div.appendChild(
  createTextField(
    "observation-table-text",
    "Blue colour solution or precipitate.",
  ),
);
...
bg3_ironObservation3Div.appendChild(
  createTextField("observation-table-text", "Deep red coloration."),
);
// #endregion Observation
...
// #region Fe Table
experimentDiv.appendChild(createTextField("observation-table-header", "Fe"));

let bg3_FeTable = createDiv("observation-table");
experimentDiv.appendChild(bg3_FeTable);
...
bg3_FeExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare aqueous solution of salt, add K3[Fe(CN)6].",
  ),
);
// #endregion Experiment
...
bg3_FeObservation1Div.appendChild(
  createTextField("observation-table-text", "Deep blue color."),
);

let bg3_FeObservation2Div = createDiv("observation-table-inner-div");
bg3_FeObservationDiv.appendChild(bg3_FeObservation2Div);
bg3_FeObservation2Div.appendChild(
  createTextField("observation-table-text", "Brown precipitate or color."),
);
// #endregion Observation
...
bg3_FeInference1Div.appendChild(
  createTextField("observation-table-text", "May be Fe2+"),
);

let bg3_FeInference2Div = createDiv("observation-table-inner-div");
bg3_FeInferenceDiv.appendChild(bg3_FeInference2Div);
bg3_FeInference2Div.appendChild(
  createTextField("observation-table-text", "Fe3+ Confirmed"),
);
// #endregion Inference
// #endregion Fe Table
