let acidicGroup3Div = createDiv("practical-file", "chemistry-practical");
// #region Sulphate Table
acidicGroup3Div.appendChild(createTextField("observation-table-header", "sulphate"));
let ag3_sulphateTable = createDiv("observation-table");
acidicGroup3Div.appendChild(ag3_sulphateTable);
// #region Experiment
...
acidicGroup3Div.appendChild(createTextField("observation-table-header", "phosphate"));
let ag3_phosphateTable = createDiv("observation-table");
acidicGroup3Div.appendChild(ag3_phosphateTable);
// #region Experiment
...
//# sourceMappingURL=group-3.js.map