...
addStyle(
  chemistryFilePath + "chemistryPracticalFile.css",
  "chemistry-practicals-style",
).onload = () => {
...
function loadBasicRadicals() {
  let basicRadicalsList = createDiv(
    "button-container practicals-list list-view",
  );
  RadicalsList.appendChild(
    createTextField("practicals-list-class-header", "Basic radicals"),
  );
  RadicalsList.appendChild(basicRadicalsList);

  let group_0 = createListButton(
    basicRadicalsList,
    "basic-group-0-btn",
    "Group-0",
  );
  group_0.addEventListener("click", () => {
    try {
      ...
      addScript(
        chemistryFilePath + "basic-radicals/group-0.js",
        "basic-group-0-script",
      ).onload = () => {
        openFile(basicGroup0Div, "Group-0");
      };
    }
  ...
  group_1.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "basic-radicals/group-1.js",
        "basic-group-1-script",
      ).onload = () => {
        openFile(basicGroup1Div, "Group-I");
      };
    }
  ...
  group_2.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "basic-radicals/group-2.js",
        "basic-group-2-script",
      ).onload = () => {
        openFile(basicGroup2Div, "Group-II");
      };
    }
  ...
  group_3.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "basic-radicals/group-3.js",
        "basic-group-3-script",
      ).onload = () => {
        openFile(basicGroup3Div, "Group-III");
      };
    }
  ...
  group_4.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "basic-radicals/group-4.js",
        "basic-group-4-script",
      ).onload = () => {
        openFile(basicGroup4Div, "Group-IV");
      };
    }
  ...
  group_5.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "basic-radicals/group-5.js",
        "basic-group-5-script",
      ).onload = () => {
        openFile(basicGroup5Div, "Group-V");
      };
    }
  ...
  group_6.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "basic-radicals/group-6.js",
        "basic-group-6-script",
      ).onload = () => {
        openFile(basicGroup6Div, "Group-VI");
      };
    }
...
function loadAcidicRadicals() {
  let acidicRadicalsList = createDiv(
    "button-container practicals-list list-view",
  );
  RadicalsList.appendChild(
    createTextField("practicals-list-class-header", "Acidic radicals"),
  );
  ...
  group_1.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "acidic-radicals/group-1.js",
        "acidic-group-1-script",
      ).onload = () => {
        openFile(acidicGroup1Div, "Group-I");
      };
    }
  ...
  group_2.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "acidic-radicals/group-2.js",
        "acidic-group-2-script",
      ).onload = () => {
        openFile(acidicGroup2Div, "Group-II");
      };
    }
  ...
  group_3.addEventListener("click", () => {
    try {
      ...
      showPracticalLoading();
      addScript(
        chemistryFilePath + "acidic-radicals/group-3.js",
        "acidic-group-3-script",
      ).onload = () => {
        openFile(acidicGroup3Div, "Group-III");
      };
    }
