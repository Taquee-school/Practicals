...
let pnJunctionDiv = document.createElement("div");
pnJunctionDiv.className = "practical-file";

let pnj_objectiveDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_objectiveDiv);
pnj_objectiveDiv.className = "practical-section";
...
let pnj_apparatusDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_apparatusDiv);
pnj_apparatusDiv.className = "practical-section";
...
let pnj_formulaDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_formulaDiv);
pnj_formulaDiv.className = "practical-section";
...
let pnj_observationDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_observationDiv);
pnj_observationDiv.className = "practical-section";
...
let pnj_characteristicsTableDiv = document.createElement("div");
pnj_characteristicsTableDiv.className = "observation-table-div";
pnj_observationDiv.appendChild(pnj_characteristicsTableDiv);

let pnj_characteristicsTable = document.createElement("div");
pnj_characteristicsTable.className = "observation-table";
...
let pnj_resultDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_resultDiv);
pnj_resultDiv.className = "practical-section";
...
let resultPDiv = document.createElement("div");
resultPDiv.className = "practical-section-input-div";

let resultP = document.createElement("p");
resultPDiv.appendChild(resultP);
...
let pnj_precautionsDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_precautionsDiv);
pnj_precautionsDiv.className = "practical-section";
...
let pnj_soeDiv = document.createElement("div");
pnJunctionDiv.appendChild(pnj_soeDiv);
pnj_soeDiv.className = "practical-section";
