...
defaultOption.addEventListener("click", () => {
  choosePalette("default");
});

// MARK: lime
const limeOption = createElement(
  "button",
  {
    id: "lime-btn-palette",
...
limeOption.addEventListener("click", () => {
  choosePalette("lime");
});

// MARK: purple
const purpleOption = createElement(
  "button",
  {
...
purpleOption.addEventListener("click", () => {
  choosePalette("purple");
});

// MARK: pink
const pinkOption = createElement(
  "button",
  {
    id: "pink-btn-palette",
    className: "radio-option",
...
// MARK: blue
const blueOption = createElement(
  "button",
  {
    id: "blue-btn-palette",
    className: "radio-option",
