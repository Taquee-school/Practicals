...
bn_OhmsLaw.addEventListener("click", () => openFile(ohmsLawDiv, "Ohms Law"));

let ohmsLawDiv = document.createElement("div");
ohmsLawDiv.className = "practical-file";

let ohl_objectiveDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohl_objectiveDiv);
ohl_objectiveDiv.className = "practical-section";
...
let ohl_apparatusDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohl_apparatusDiv);
ohl_apparatusDiv.className = "practical-section";
...
let ohl_formulaDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohl_formulaDiv);
ohl_formulaDiv.className = "practical-section";
...
let ohl_observationDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohl_observationDiv);
ohl_observationDiv.className = "practical-section";
...
let ohl_resistanceTableDiv = document.createElement("div");
ohl_resistanceTableDiv.className = "observation-table-div";
ohl_observationDiv.appendChild(ohl_resistanceTableDiv);

let ohl_resistanceTable = document.createElement("div");
ohl_resistanceTable.className = "observation-table";
...
let ohl_resultDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohl_resultDiv);
ohl_resultDiv.className = "practical-section";
...
let ohl_precautionsDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohl_precautionsDiv);
ohl_precautionsDiv.className = "practical-section";
...
let ohmsLaw_soeDiv = document.createElement("div");
ohmsLawDiv.appendChild(ohmsLaw_soeDiv);
ohmsLaw_soeDiv.className = "practical-section";
