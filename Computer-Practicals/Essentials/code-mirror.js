!function(e, t) {
    ...
    function Le() {}
    function ke(e, t) {
        e = Object.create ? Object.create(e) : (Le.prototype = e,
        new Le);
        return t && fe(t, e),
        e
    }
    ...
    function We(e, t, n) {
        for (; (n < 0 ? 0 < t : t < e.length) && De(e.charAt(t)); )
            t += n;
        return t
    }
    function He(e, t, n) {
    ...
    var Ee, Re, ze, Ie, Be, Ge = function(e, t) {
        ...
        for (var O, A = [], D = 0; D < i; )
            if (Ie.test(o[D])) {
                ...
                for (var P = W; P < D; )
                    if (Be.test(o[P])) {
                        W < P && (A.splice(H, 0, new Ue(1,W,P)),
                        H += F);
                        var R = P;
                        for (++P; P < D && Be.test(o[P]); ++P)
                            ;
                        A.splice(H, 0, new Ue(2,R,P)),
                        H += F,
                        W = P
                    } else
                        ++P;
        ...
        A.unshift(new Ue(0,0,O[0].length))),
        1 == z(A).level && (O = e.match(/\s+$/)) && (z(A).to -= O[0].length,
        A.push(new Ue(0,i - O[0].length,i)))),
        "rtl" == t ? A.reverse() : A
    };
    function Ue(e, t, n) {
        this.level = e,
    ...
    : function(e) {
      ...
      , ot = "oncopy"in (l = M("div")) || (l.setAttribute("oncopy", "return;"),
    "function" == typeof l.oncopy)
      , lt = null;
    var st = {}
      , at = {};
    function ut(e) {
        if ("string" == typeof e && at.hasOwnProperty(e))
            e = at[e];
    ...
    function Dt(e, t, n) {
        var r, i, o;
        return t.styles && t.styles[0] == e.state.modeGen || (r = Wt(e, H(t)),
        i = t.text.length > e.options.maxHighlightLength && ft(e.doc.mode, r.state),
        o = At(e, t, r),
        i && (r.state = i),
    ...
    function Wt(n, r, e) {
        ...
        var o = function(e, t, n) {
            for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; l < s; --s) {
                ...
                var a = W(o, s - 1)
                  , u = a.stateAfter;
                if (u && (!n || s + (u instanceof Nt ? u.lookAhead : 0) <= o.modeFrontier))
                    return s;
    ...
    function Rt(e, t, n, r) {
        var i, o, l = e.doc, s = l.mode, a = W(l, (t = E(l, t)).line), u = Wt(e, t.line, n), c = new g(a.text,e.options.tabSize,u);
    ...
    function Kt(e, t) {
          ...
          , s = function(e, t, n) {
            ...
            if (e)
                for (var i = 0; i < e.length; ++i) {
                    ...
                    (r = r || []).push(new Ut(s,o ? null : l.from - t,null == l.to ? null : l.to - t)))
                }
            return r
        }(e, i, o)
          , a = 1 == t.text.length
        ...
        if (s)
            for (var f = 0; f < s.length; ++f) {
                var p = s[f];
                null != p.to && (p.to += u),
                null == p.from ? Vt(l, p.marker) || (p.from = u,
    ...
    function Zt(e, t) {
        ...
        if (r)
            for (var i, o = 0; o < r.length; ++o)
                (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || qt(n, i.marker) < 0) && (n = i.marker);
        return n
    }
    function Qt(e) {
        return Zt(e, !0)
    ...
    function fn(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            function(e) {
                ...
                return te(e),
                n && n.left != n.right && (tt = t.right - n.right < 3)
                        ...
                        if (v == p) {
                            ...
                            if (!h || h.from == p)
                                for (var k = 0; k < y.length; ++k)
                                    mn(t, 0, y[k]);
                            if (h && (h.from || 0) == p) {
                                if (mn(t, (null == h.to ? f + 1 : h.to) - p, h.marker, null == h.from),
                                null == h.to)
                                    return;
                                h.to == p && (h = !1)
                            }
            ...
            0 != l.firstChild.offsetHeight && (et = o.offsetWidth <= 1 && 2 < o.offsetHeight && !(w && v < 8))),
            (l = et ? M("span", "​") : M("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px")).setAttribute("cm-text", ""),
            l))),
        ...
        if (t) {
            ...
            if (a.test(t))
                for (var c = document.createDocumentFragment(), h = 0; ; ) {
                    ...
                    (p = c.appendChild(M("span", Ce(f), "cm-tab"))).setAttribute("role", "presentation"),
    ...
    function b(e, t) {
        var n = je(e, t);
        if (n.length)
            for (var r, i = Array.prototype.slice.call(arguments, 2), o = (bn ? r = bn.delayedCallbacks : wn ? r = wn : (r = wn = [],
            setTimeout(xn, 0)),
            0); o < n.length; ++o)
                !function(e) {
                    r.push(function() {
    ...
    function Tn(e, t, n, r) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", xt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
            i)
    ...
    function Bn(e, t) {
        var n, r, i = H(t), o = In(e, i), e = (o && !o.text ? o = null : o && o.changes && (Cn(e, o, i, hr(e)),
    ...
    function Gn(e, t, n, r, i) {
        ...
        if (t.cache.hasOwnProperty(l))
            ...
            (o = function(e, t, n, r) {
                var i, o = Kn(t.map, n, r), l = o.node, s = o.start, a = o.end, u = o.collapse;
                if (3 == l.nodeType) {
                    for (var c = 0; c < 4; c++) {
                        for (; s && De(t.line.text.charAt(o.coverStart + s)); )
                            --s;
                        for (; o.coverStart + a < o.coverEnd && De(t.line.text.charAt(o.coverStart + a)); )
                            ++a;
    ...
    function Zn(e, t, n, r, i) {
        ...
        r = r || "local";
        i = ln(t);
        return "local" == r ? i += Dn(e.display) : i -= e.display.viewOffset,
        "page" != r && "window" != r || (i += (t = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : _n(ae(e))),
    ...
    function Qn(e, t, n) {
        ...
        var r = t.left
          , t = t.top
          , n = ("page" == n ? (r -= $n(ae(e)),
        t -= _n(ae(e))) : "local" != n && n || (r += (n = e.display.sizer.getBoundingClientRect()).left,
        t += n.top),
    ...
    function rr(e, t, n) {
        ...
        if ((n += e.display.viewOffset) < 0)
            return nr(r.first, 0, null, -1, -1);
        var i = bt(r, n)
          , o = r.first + r.size - 1;
        if (o < i)
            return nr(r.first + r.size - 1, W(r, o).text.length, null, 1, 1);
        t < 0 && (t = 0);
        for (var l = W(r, i); ; ) {
            var s = function(n, e, t, r, i) {
                ...
                c && (c = (n.options.lineWrapping ? ar : sr)(n, e, t, o, c, r, i),
                u = 1 != c.level,
                s = u ? c.from : c.to - 1,
                a = u ? c.to : c.from - 1);
                var h = null
                  ...
                  , c = He(function(e) {
                    ...
                    return t.top += l,
                    t.bottom += l,
                    lr(t, r, i, !1) && (t.top <= i && t.left <= r && (h = e,
                    d = t),
                    1)
                }, s, a)
                  , f = !1;
                {
                    ...
                    g = 0 == c || c != e.text.length && Gn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before",
                    a = er(n, F(t, c, g), "line", e, o),
                    p = a.left,
                    f = i < a.top ? -1 : i >= a.bottom ? 1 : 0)
                }
                return c = We(e.text, c, 1),
                nr(t, c, g, f, r - p)
            }(e, l, i, t, n)
              , a = function(e, t) {
                var n, r = Gt && e.markedSpans;
    ...
    function sr(n, r, i, o, l, s, a) {
        ...
        lr(e = er(n, F(i, e ? u.from : u.to, e ? "after" : "before"), "line", r, o), s, a, !0) && e.top > a && (u = l[t - 1])),
        u
    }
    function ar(e, t, n, r, i, o, l) {
        for (var l = ir(e, t, r, l), s = l.begin, a = l.end, u = (/\s/.test(t.text.charAt(a - 1)) && a--,
        null), c = null, h = 0; h < i.length; h++) {
            var d, f = i[h];
            f.from >= a || f.to <= s || (d = (d = Gn(e, r, 1 != f.level ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right) < o ? o - d + 1e9 : d - o,
            (!u || d < c) && (u = f,
            c = d))
        }
    ...
    function gr(e, t, n, r) {
        ...
        i = F(i.line, Math.max(0, Math.round((o - Hn(e.display).left) / cr(e.display)) - n))),
        i
    }
    function mr(e, t) {
    ...
    function R(e, t, n, r) {
        ...
        t >= o.viewTo ? Gt && nn(e.doc, t) < o.viewTo && yr(e) : n <= o.viewFrom ? Gt && rn(e.doc, n + r) > o.viewFrom ? yr(e) : (o.viewFrom += r,
        o.viewTo += r) : t <= o.viewFrom && n >= o.viewTo ? yr(e) : t <= o.viewFrom ? (l = br(e, n, n + r, 1)) ? (o.view = o.view.slice(l.index),
        o.viewFrom = l.lineN,
        o.viewTo += r) : yr(e) : n >= o.viewTo ? (l = br(e, t, t, -1)) ? (o.view = o.view.slice(0, l.index),
        o.viewTo = l.lineN) : yr(e) : (l = br(e, t, t, -1),
        i = br(e, n, n + r, 1),
        l && i ? (o.view = o.view.slice(0, l.index).concat(yn(e, l.lineN, i.lineN)).concat(o.view.slice(i.index)),
        o.viewTo += r) : yr(e)),
        o.externalMeasured);
    ...
    function vr(e, t, n) {
        ...
        t < r.viewFrom || t >= r.viewTo || null != (i = r.view[mr(e, t)]).node && -1 == L(r = i.changes || (i.changes = []), n) && r.push(n)
    }
    function yr(e) {
    ...
    function br(e, t, n, r) {
        var i, o = mr(e, t), l = e.display.view;
        if (!Gt || n == e.doc.first + e.doc.size)
            return {
                index: o,
                lineN: n
            };
    ...
    function Cr(e, t) {
        ...
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
            ...
            l ? (u = l(e, s)) && Sr(e, u, i) : (a || e.options.showCursorWhenSelecting) && Sr(e, s.head, i),
            a || function(i, e, t) {
                var n = i.display
                  , o = i.doc
    ...
    function Sr(e, t, n) {
        ...
        /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) && (t = (t = Jn(e, t, "div", null, null)).right - t.left,
            ...
            if (!s.hidden) {
                ...
                s.rest))
                    for (var d = 0; d < s.rest.length; d++)
                        Dr(s.rest[d]);
                c > e.display.sizerWidth && ((a = Math.ceil(c / cr(e.display))) > e.display.maxLineLength && (e.display.maxLineLength = a,
    ...
    function Wr(e, t, n) {
        var r, i = n && null != n.top ? Math.max(0, n.top) : e.scroller.scrollTop, i = Math.floor(i - Dn(e)), o = n && null != n.bottom ? n.bottom : i + e.wrapper.clientHeight, i = bt(t, i), o = bt(t, o);
        return n && n.ensure && (r = n.ensure.from.line,
        n = n.ensure.to.line,
        r < i ? o = bt(t, ln(W(t, i = r)) + e.wrapper.clientHeight) : Math.min(n, t.lastLine()) >= o && (i = bt(t, ln(W(t, n)) - e.wrapper.clientHeight),
        o = n)),
        {
            from: i,
            to: Math.max(o, i + 1)
    ...
    function $r(n) {
        ...
        n.display.scrollbars = new Yr[n.options.scrollbarStyle](function(e) {
    ...
    function qr(e) {
        ...
        e = e.curOp,
        bn ? bn.ops.push(e) : e.ownsGroup = bn = {
            ops: [e],
            delayedCallbacks: []
        }
    }
        ...
        if (e) {
            var t = function(e) {
                ...
                for (var n = e.ops, r = 0; r < n.length; r++) {
                    ...
                    i.update = i.mustUpdate && new ei(o,i.mustUpdate && {
                        top: i.scrollTop,
                ...
                for (var u = 0; u < n.length; u++) {
                    ...
                    c.barMeasure = Ur(h),
                    d.maxLineChanged && !h.options.lineWrapping && (c.adjustWidthTo = zn(h, d.maxLine, d.maxLine.text.length).left + 3,
                    h.display.sizerWidth = c.adjustWidthTo,
                    c.barMeasure.scrollWidth = Math.max(d.scroller.clientWidth, d.sizer.offsetLeft + c.adjustWidthTo + Fn(h) + h.display.barWidth),
                    c.maxScrollLeft = Math.max(0, d.sizer.offsetLeft + c.adjustWidthTo - Pn(h)));
                ...
                for (var f = 0; f < n.length; f++) {
                    ...
                    p.maxScrollLeft < g.doc.scrollLeft && Gr(g, Math.min(g.display.scroller.scrollLeft, p.maxScrollLeft), !0),
                ...
                for (var v, y = 0; y < n.length; y++) {
                    ...
                    b.scrollToPos && (v = function(e, t, n, r) {
                        ...
                        for (var i = 0; i < 5; i++) {
                            var o, l = !1, s = er(e, t), a = n && n != t ? er(e, n) : s, s = Hr(e, o = {
                            ...
                            null != s.scrollLeft && (Gr(e, s.scrollLeft),
    ...
    function Jr(l) {
        ...
        c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function(e) {
            if (a.line >= l.display.viewFrom) {
                for (var t = e.styles, n = e.text.length > l.options.maxHighlightLength ? ft(c.mode, a.state) : null, r = At(l, e, a, !0), n = (n && (a.state = n),
                e.styles = r.styles,
    ...
    function ti(e, t) {
        ...
        if (t.editorIsHidden)
            return yr(e),
            !1;
        if (!t.force && t.visible.from >= n.viewFrom && t.visible.to <= n.viewTo && (null == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo) && n.renderedView == n.view && 0 == wr(e))
            return !1;
        si(e) && (yr(e),
        t.dims = hr(e));
        ...
        o != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth)
          , i = (i = o,
        o = l,
        0 == (c = (l = e).display).view.length || i >= c.viewTo || o <= c.viewFrom ? (c.view = yn(l, i, o),
        c.viewFrom = i) : (c.viewFrom > i ? c.view = yn(l, i, c.viewFrom).concat(c.view) : c.viewFrom < i && (c.view = c.view.slice(mr(l, i))),
        c.viewFrom = i,
        c.viewTo < o ? c.view = c.view.concat(yn(l, c.viewTo, o)) : c.viewTo > o && (c.view = c.view.slice(0, mr(l, o)))),
        c.viewTo = o,
        ...
        var l = function(e) {
            if (e.hasFocus())
                return null;
            if (!(n = N(ue(e))) || !re(e.display.lineDiv, n))
                return null;
            var t, n = {
                activeElt: n
            };
            return window.getSelection && (t = he(e).getSelection()).anchorNode && t.extend && re(e.display.lineDiv, t.anchorNode) && (n.anchorNode = t.anchorNode,
        ...
        for (var g = c.view, m = c.viewFrom, v = 0; v < g.length; v++) {
            ...
            if (!y.hidden)
                if (y.node && y.node.parentNode == d) {
                    ...
                    Cn(s, y, m, u)),
                    b && (te(y.lineNumber),
                    y.lineNumber.appendChild(document.createTextNode(xt(s.options, m)))),
        ...
        (o = l) && o.activeElt && o.activeElt != N(ce(o.activeElt)) && (o.activeElt.focus(),
    ...
    function oi(e, t) {
        ...
        e.display.gutters.style.height = t.docHeight + e.display.barHeight + Fn(e) + "px"
    }
    function li(e) {
        var t = e.display
          , n = t.view;
    ...
    function hi(e, t, n, r) {
        ...
        i.sizerWidth = null,
        i.heightForcer = M("div", null, null, "position: absolute; height: " + ge + "px; width: 1px;"),
    ...
    function mi(e, t) {
        ...
        if (r && s || n && a) {
            ...
            di < 20 && 0 !== t.deltaMode && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
    ...
    B.prototype.equals = function(e) {
        ...
        for (var t = 0; t < this.ranges.length; t++) {
            var n = this.ranges[t]
              , r = e.ranges[t];
            if (!Ct(n.anchor, r.anchor) || !Ct(n.head, r.head))
                return !1
        }
        return !0
    }
    ...
    function vi(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            ...
            (r && !l.empty() ? 0 < a : 0 <= a) && (a = kt(s.from(), l.from()),
            o = Lt(s.to(), l.to()),
    ...
    function wi(e, t) {
        ...
        var n = e.line + t.text.length - (t.to.line - t.from.line) - 1
          , r = e.ch;
        return e.line == t.to.line && (r += bi(t).ch - t.to.ch),
        F(n, r)
    }
    function xi(e, t) {
    ...
    function Si(e) {
        e.doc.mode = ct(e.options, e.doc.modeOption),
        Li(e)
    }
    function Li(e) {
    ...
    function Ti(e, o, t, l) {
        ...
        e.remove(c.length, e.size - c.length)) : ki(e, o) ? (s = r(0, c.length - 1),
        n(d, d.text, p),
        g && e.remove(a.line, g),
        s.length && e.insert(a.line, s)) : h == d ? 1 == c.length ? n(h, h.text.slice(0, a.ch) + f + h.text.slice(u.ch), p) : ((s = r(1, c.length - 1)).push(new un(f + h.text.slice(u.ch),p,l)),
    ...
    function Hi(e, t, n, r) {
        ...
        +new Date);
        if ((l.lastOp == r || l.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (o = l).lastOp == r ? (Wi(o.done),
        z(o.done)) : o.done.length && !z(o.done).ranges ? z(o.done) : 1 < o.done.length && !o.done[o.done.length - 2].ranges ? (o.done.pop(),
        z(o.done)) : void 0))
            i = z(o.changes),
            0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? i.to = bi(t) : o.changes.push(Di(e, t));
        else {
            var a = z(l.done);
            for (a && a.ranges || Pi(e.sel, l.done),
            o = {
                changes: [Di(e, t)],
    ...
    function Fi(e, t, n, r) {
        ...
        o = z(s.done),
        l = t,
        "*" == (i = i.charAt(0)) || "+" == i && o.ranges.length == l.ranges.length && o.somethingSelected() == l.somethingSelected() && new Date - e.history.lastSelTime <= (e.cm ? e.cm.options.historyEventDelay : 500))) ? s.done[s.done.length - 1] = t : Pi(t, s.done),
    ...
    function Vi(e, t, n, r) {
        ...
        i[t] = n,
        U(e, vi(e.cm, i, e.sel.primIndex), r)
    }
    function Ki(e, t, n, r) {
        U(e, yi(t, n), r)
    }
    ...
    function Xi(e, t, n) {
        ...
        Yi(e, _i(e, t, o, !0)),
        n && !1 === n.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || Pr(e.cm)
    }
    function Yi(e, t) {
    ...
    function Zi(e, t, n, r, i) {
        r = r || 1,
        i = qi(e, t, n, r, i) || !i && qi(e, t, n, r, !0) || qi(e, t, n, -r, i) || !i && qi(e, t, n, -r, !0);
    ...
    function no(e, n) {
        var t, r;
        1 == n.text.length && "" == n.text[0] && 0 == P(n.from, n.to) || (t = xi(e, n),
        Hi(e, n, t, e.cm ? e.cm.curOp.id : NaN),
        oo(e, n, t, Kt(e, n)),
        r = [],
        Mi(e, function(e, t) {
            t || -1 != L(r, e.history) || (uo(e.history, n),
            r.push(e.history)),
            oo(e, n, null, Kt(e, n))
        }))
    }
    function ro(i, o, e) {
        ...
        if (!t || e) {
            ...
            if (u != s.length) {
                ...
                Ye(i, "beforeChange") || i.cm && Ye(i.cm, "beforeChange")), d = l.changes.length - 1; 0 <= d; --d) {
                    var f = function(e) {
                        var n = l.changes[e];
                        if (n.origin = o,
                        h && !eo(i, n, !1))
    ...
    function io(e, t) {
        if (0 != t && (e.first += t,
        e.sel = new B(Se(e.sel.ranges, function(e) {
    ...
    function oo(e, t, n, r) {
        if (e.cm && !e.cm.curOp)
            return I(e.cm, oo)(e, t, n, r);
        if (t.to.line < e.first)
            io(e, t.text.length - 1 - (t.to.line - t.from.line));
        else if (!(t.from.line > e.lastLine())) {
            t.from.line < e.first && (io(e, i = t.text.length - 1 - (e.first - t.from.line)),
            t = {
                from: F(e.first, 0),
            ...
            e.cm) {
                var i = e.cm
                  ...
                  , h = !1
                  , d = u.line
                  , f = (i.options.lineWrapping || (d = H(tn(W(s, u.line))),
                ...
                o.full ? R(i) : u.line != c.line || 1 != o.text.length || ki(i.doc, o) ? R(i, u.line, c.line + 1, l) : vr(i, u.line, "text"),
                d = Ye(i, "changes"),
                ((s = Ye(i, "change")) || d) && (l = {
                    from: u,
                    to: c,
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    so(o.ranges[s].anchor, t, n, r),
                    so(o.ranges[s].head, t, n, r)
            } else {
    ...
    function co(e, t, n, r) {
        var i = t
          , o = t;
        return "number" == typeof t ? o = W(e, Tt(e, t)) : i = H(t),
    ...
    fo.prototype = {
        ...
        removeInner: function(e, t) {
            ...
            this.size - t < 25 && (1 < this.children.length || !(this.children[0]instanceof ho)) && (this.collapse(n = []),
        ...
        maybeSpill: function() {
            if (!(this.children.length <= 10)) {
                ...
                e.parent.children.splice(t + 1, 0, n)) : (((t = new fo(e.children)).parent = e).children = [t, n],
                e = t),
                n.parent = e.parent,
    ...
    po.prototype.changed = function() {
        var e = this
          ...
          , i = (this.height = null,
        On(this) - t);
        i && (on(this.doc, r) || yt(r, r.height + i),
        n && h(n, function() {
    ...
    function yo(r, i, o, e, t) {
        ...
        d.collapsed) {
            if (en(r, i.line, i, o, d) || i.line != o.line && en(r, o.line, i, o, d))
        ...
        if (r.iter(g, o.line + 1, function(e) {
            var t, n;
            m && d.collapsed && !m.options.lineWrapping && tn(e) == m.display.maxLine && (p = !0),
    ...
    mo.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            for (var e, t = this.doc.cm, n = t && !t.curOp, r = (n && qr(t),
            !Ye(this, "clear") || (e = this.find()) && b(this, "clear", e.from, e.to),
            null), i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o]
                  , s = Vt(l.markedSpans, this);
                t && !this.collapsed ? vr(t, H(l), "text") : t && (null != s.to && (i = H(l)),
                null != s.from && (r = H(l))),
                ...
                null == s.from && this.collapsed && !on(this.doc, l) && t && yt(l, ur(t.display))
            }
    ...
    mo.prototype.changed = function() {
        ...
        r && o && h(o, function() {
            ...
            on(i.doc, e) || null == i.height || (t = i.height,
            i.height = null,
      ...
      , So = ((f.prototype = ke(fo.prototype, {
        ...
        setGutterMarker: n(function(e, n, r) {
            return co(this, e, "gutter", function(e) {
                ...
                return !(t[n] = r) && Oe(t) && (e.gutterMarkers = null),
                1
            })
        }),
        ...
        linkedDoc: function(e) {
            ...
            new f(vt(this, t, n),e.mode || this.modeOption,t,this.lineSep,this.direction)), r = (e.sharedHist && (n.history = this.history),
            ...
            n), i = wo(this), o = 0; o < i.length; o++) {
                var l = i[o]
                  ...
                  , a = r.clipPos(s.from)
                  , s = r.clipPos(s.to);
                P(a, s) && (a = yo(r, a, s, l.primary, l.primary.type),
                l.markers.push(a),
                a.parent = l)
            }
            return n
                ...
                if (n && n.length && window.FileReader && window.File)
                    for (var i = n.length, o = Array(i), l = 0, s = function() {
                        ++l == i && I(r, function() {
                            ...
                            to(r.doc, e),
                            ji(r.doc, yi(E(r.doc, t), E(r.doc, bi(e))))
                        })()
                    }, a = 0; a < n.length; a++)
                        !function(e, t) {
                            var n;
    ...
    for (var Wo = 65; Wo <= 90; Wo++)
        Ao[Wo] = String.fromCharCode(Wo);
    for (var Ho = 1; Ho <= 12; Ho++)
        Ao[Ho + 111] = Ao[Ho + 63235] = "F" + Ho;
    var Fo = {};
    function Po(e) {
    ...
    function jo(e, t, n, r, i) {
        if (e) {
            ...
            if (e)
                ...
                0 < e.level || "rtl" == t.doc.direction ? (l = Bn(t, n),
                s = i < 0 ? n.text.length - 1 : 0,
                a = Gn(t, l, s).top,
                s = He(function(e) {
                    return Gn(t, l, e).top == a
                }, i < 0 == (1 == e.level) ? e.from : e.to - 1, s),
                "before" == o && (s = Vo(n, s, 1))) : s = i < 0 ? e.to : e.from,
                new F(r,s,o)
        }
    ...
    function Xo(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || Bn(t, n),
            or(t, n, l, e)) : {
                begin: 0,
                end: n.text.length
            }
    ...
    function nl(e) {
        ...
        e.target && e.target != i.display.input.getField() || (i.curOp.focus = N(ue(i)),
        A(i, e) || (w && v < 11 && 27 == e.keyCode && (e.returnValue = !1),
        t = e.keyCode,
        i.display.shift = 16 == t || e.shiftKey,
        n = el(i, e),
        K && (tl = n ? t : null,
        !n && 88 == t && !ot && (C ? e.metaKey : e.ctrlKey) && i.replaceSelection("", null, "cut")),
    ...
    function al(e) {
        ...
        h.shift = e.shiftKey,
        An(h, e) ? x || (h.scroller.draggable = !1,
        setTimeout(function() {
        ...
        o = n,
        r = +new Date,
        sl && sl.compare(r, i, o) ? (ll = sl = null,
        "triple") : ll && ll.compare(r, i, o) ? (sl = new ol(r,i,o),
        ll = null,
        "double") : (ll = new ol(r,i,o),
        sl = null,
        "single")) : "single",
        he(c).focus(),
        ...
        u = i.doc.sel,
        (i.options.dragDrop && nt && !i.isReadOnly() && "single" == l && -1 < (l = u.contains(o)) && (P((l = u.ranges[l]).from(), o) < 0 || 0 < o.xRel) && (0 < P(l.to(), o) || o.xRel < 0) ? function(t, n, r, i) {
            var o = t.display
              , l = !1
              , s = I(t, function(e) {
                x && (o.scroller.draggable = !1),
                t.state.draggingText = !1,
                t.state.delayingBlurEvent && (t.hasFocus() ? t.state.delayingBlurEvent = !1 : Mr(t)),
        ...
        : function(d, e, f, p) {
            ...
            f = gr(d, e, !0, !0),
            v = -1) : (e = ul(d, f, p.unit),
            m = p.extend ? Bi(m, e.anchor, e.head, p.extend) : e);
            ...
            y = g.sel) : Vi(g, v, m, ye) : (U(g, new B([m],v = 0), ye),
            y = g.sel);
            var b = f;
            function s(e) {
                if (0 != P(b, e))
                    ...
                    "rectangle" == p.unit) {
                        ...
                        var h, r = m, i = ul(d, e, p.unit), e = r.anchor, e = 0 < P(i.anchor, e) ? (h = i.head,
                        kt(r.from(), i.anchor)) : (h = i.anchor,
                        Lt(r.to(), i.head)), r = y.ranges.slice(0);
                        r[v] = function(e, t) {
                            var n = t.anchor
                              , r = t.head
                              , i = W(e.doc, n.line);
                            ...
                            if (0 == s || s == i.length)
                                return t;
                            l = r.line != n.line ? 0 < (r.line - n.line) * ("ltr" == e.doc.direction ? 1 : -1) : (e = Pe(i, r.ch, r.sticky),
            ...
            var r = I(d, function(e) {
                (0 !== e.buttons && Je(e) ? function e(t) {
                    var n, r, i = ++u, o = gr(d, t, !0, "rectangle" == p.unit);
                    o && (0 != P(o, b) ? (d.curOp.focus = N(ue(d)),
                    s(o),
                    n = Wr(l, g),
                    (o.line >= n.to || o.line < n.from) && setTimeout(I(d, function() {
                        u == i && e(t)
        ...
        )(i, s, o, a)) : Qe(e) == h.scroller && D(e) : 2 == n ? (t && Gi(c.doc, t),
        setTimeout(function() {
    ...
    function dl(e, t) {
        var n, r;
        An(e.display, t) || (r = t,
        Ye(n = e, "gutterContextMenu") && cl(n, r, "gutterContextMenu", !1)) || A(e, t, "contextmenu") || Q || e.display.input.onContextMenu(t)
    }
    function fl(e) {
    ...
    var pl = {
      ...
      , ml = {};
    function vl(e, t, n) {
        !t != !(n && n != pl) && (n = e.display.dragFunctions,
    ...
    function p(e, t) {
        ...
        if (!(this instanceof p))
            return new p(e,t);
        this.options = t = t ? fe(t) : {},
        fe(gl, t, !1);
        var r, i = t.value, o = ("string" == typeof i ? i = new f(i,t.mode,null,t.lineSeparator,t.direction) : t.mode && (i.modeOption = t.mode),
        this.doc = i,
        new p.inputStyles[t.inputStyle](this)), e = this.display = new hi(e,i,o,t), l = (fl(e.wrapper.CodeMirror = this),
        ...
        k(s.scroller, "dblclick", w && v < 11 ? I(l, function(e) {
            var t;
            A(l, e) || (!(t = gr(l, e)) || hl(l, e) || An(l.display, e) || (D(e),
            e = l.findWordAt(t),
            Gi(l.doc, e.anchor, e.head)))
        }) : function(e) {
            return A(l, e) || D(e)
        }
        ),
        ...
        k(s.scroller, "touchend", function(e) {
            ...
            n && !An(s, e) && null != n.left && !n.moved && new Date - n.start < 300 && (t = l.coordsChar(s.activeTouch, "page"),
        ...
        s.dragFunctions = {
            ...
            over: function(e) {
                var t, n;
                A(l, e) || ((n = gr(t = l, n = e)) && (Sr(t, n, n = document.createDocumentFragment()),
            ...
            start: function(e) {
                ...
                t = l,
                e = e,
                w && (!t.state.draggingText || +new Date - So < 100) ? Ze(e) : A(t, e) || An(t.display, e) || (e.dataTransfer.setData("Text", t.getSelection()),
    ...
    var bl = [];
    function wl(e, t, n, r) {
        var i, o = e.doc, l = ("smart" == (n = null == n ? "add" : n) && (o.mode.indent ? i = Wt(e, t).state : n = "prev"),
        ...
        if (d < c && (h += Ce(c - d)),
        h != u)
            return lo(o, h, F(t, 0), F(t, u.length), "+input"),
            !(s.stateAfter = null);
    ...
    function Sl(e, t, n, r, i) {
        ...
        if (s && 1 < r.ranges.length)
            if (xl && xl.text.join("\n") == t) {
                ...
                a.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = Se(a, function(e) {
                    return [e]
                }));
            ...
            for (var n = e.doc.sel, r = n.ranges.length - 1; 0 <= r; r--) {
                ...
                if (!(100 < i.head.ch || r && n.ranges[r - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(W(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = wl(e, i.head.line, "smart"));
    ...
    function Ol(n, r, i, o, l) {
        ...
        function u(e) {
            ...
            new F(r.line,Math.max(0, Math.min(s.text.length, r.ch + i * (t ? 2 : 1))),-i))) : l ? Xo(n.cm, s, r, i) : Ko(s, r, i))) {
        ...
        t = Zi(n, r, e, t, !0);
        return Ct(e, t) && (t.hitSide = !0),
        t
    }
    function Al(e, t, n, r) {
        var i, o, l, s = e.doc, a = t.left;
        for ("page" == r ? (i = Math.min(e.display.wrapper.clientHeight, he(e).innerHeight || s(e).documentElement.clientHeight),
        i = Math.max(i - .5 * ur(e.display), 3),
        o = (0 < n ? t.bottom : t.top) + n * i) : "line" == r && (o = 0 < n ? t.bottom + 3 : t.top - 3); (l = rr(e, a, o)).outside; ) {
    ...
    r.prototype.init = function(e) {
        ...
        s.contentEditable = !0,
        Ml(s, l.options.spellcheck, l.options.autocorrect, l.options.autocapitalize),
    ...
    r.prototype.prepareSelection = function() {
        var e = Cr(this.cm, !1);
        return e.focus = N(ce(this.div)) == this.div,
        e
    }
    ,
    ...
    r.prototype.focus = function() {
        "nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && N(ce(this.div)) == this.div || this.showSelection(this.prepareSelection(), !0),
        this.div.focus())
    }
    ,
    ...
    r.prototype.pollContent = function() {
        ...
        i.line < n.viewFrom || r.line > n.viewTo - 1)
            return !1;
        var o, l = i.line == n.viewFrom || 0 == (l = mr(t, i.line)) ? (e = H(n.view[0].line),
        n.view[0].node) : (e = H(n.view[l].line),
        n.view[l - 1].node.nextSibling), r = mr(t, r.line), n = r == n.view.length - 1 ? (o = n.viewTo - 1,
        ...
        return 1 < s.length || s[0] || P(r, l) ? (lo(t.doc, s, r, l, "+input"),
        !0) : void 0
    }
    ,
    ...
    r.prototype.onKeyPress = function(e) {
        ...
        this.cm.isReadOnly() || I(this.cm, Sl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    }
    ,
    ...
    i.prototype.init = function(n) {
        ...
        function t(e) {
            if (!A(i, e)) {
                if (i.somethingSelected())
                    ...
                    "cut" == e.type ? i.setSelections(t.ranges, null, ve) : (r.prevInput = "",
                    o.value = t.text.join("\n"),
                    se(o))
                }
        ...
        k(o, "paste", function(e) {
            A(i, e) || Ll(e, i) || (i.state.pasteIncoming = +new Date,
            r.fastPoll())
        }),
        k(o, "cut", t),
        k(o, "copy", t),
    ...
    i.prototype.prepareSelection = function() {
        var e, t = this.cm, n = t.display, r = t.doc, i = Cr(t);
        return t.options.moveInputWithCursor && (t = er(t, r.sel.primary().head, "div"),
    ...
    i.prototype.reset = function(e) {
        var t, n;
        this.contextMenuPending || this.composing && e || (t = this.cm,
        this.resetting = !0,
    ...
    i.prototype.focus = function() {
        if ("nocursor" != this.cm.options.readOnly && (!_ || N(ce(this.textarea)) != this.textarea))
            try {
                this.textarea.focus()
            } catch (e) {}
    }
    ...
    i.prototype.poll = function() {
        var e = this
          ...
          , n = this.textarea
          , r = this.prevInput;
        if (this.contextMenuPending || this.resetting || !t.state.focused || it(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
            return !1;
        var i = n.value;
        ...
        for (var l = 0, s = Math.min(r.length, i.length); l < s && r.charCodeAt(l) == i.charCodeAt(l); )
            ++l;
        return h(t, function() {
            Sl(t, i.slice(l), r.length - l, null, e.composing ? "*compose" : null),
    ...
    i.prototype.onContextMenu = function(e) {
        ...
        function d() {
            ...
            e = 0,
            t = function() {
                s.selForContextMenu == l.doc.sel && 0 == a.selectionStart && 0 < a.selectionEnd && "​" == o.prevInput ? I(l, Ji)(l) : e++ < 10 ? s.detectingSelectAll = setTimeout(t, 500) : (s.selForContextMenu = null,
                s.input.reset())
            }
            ,
            s.detectingSelectAll = setTimeout(t, 200)))
        }
        u && !K && (l.options.resetSelectionOnContextMenu && -1 == l.doc.sel.contains(u) && I(l, U)(l.doc, yi(u), ve),
        n = a.style.cssText,
    ...
    o("gutters", [], function(e, t) {
        e.display.gutterSpecs = ai(t, e.options.lineNumbers),
        ci(e)
    }, !0),
    ...
    o("lineNumbers", !1, function(e, t) {
        e.display.gutterSpecs = ai(e.options.gutters, t),
        ci(e)
    }, !0),
    ...
    El.prototype = {
        ...
        indentSelection: t(function(e) {
            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                var i = t[r];
                if (i.empty())
                    i.head.line > n && (wl(this, i.head.line, e, !0),
                    n = i.head.line,
        ...
        getTokenTypeAt: function(e) {
            e = E(this.doc, e);
            var t, n = Dt(this, W(this.doc, e.line)), r = 0, i = (n.length - 1) / 2, o = e.ch;
            if (0 == o)
                t = n[2];
            else
                for (; ; ) {
        ...
        addWidget: function(e, t, n, r, i) {
            var o, l, s = this.display, a = (e = er(this, E(this.doc, e))).bottom, u = e.left;
        ...
        findPosH: function(e, t, n, r) {
            ...
            t = -t),
            E(this.doc, e)), l = 0; l < t && !(o = Ol(this.doc, o, i, n, r)).hitSide; ++l)
                ;
            return o
        },
        ...
        moveV: t(function(r, i) {
            ...
            if (l.extendSelectionsBy(function(e) {
                ...
                s.push(t.left),
                Al(o, t, r, i));
                return "page" == i && e == l.sel.primary() && Fr(o, Jn(o, n, "div").top - t.top),
                n
            }, be),
            s.length)
        ...
        findWordAt: function(e) {
            ...
            if (t) {
                ...
                t.charAt(n)), l = Ne(o, i) ? function(e) {
                    return Ne(e, i)
                }
                : /\s/.test(o) ? function(e) {
                    return /\s/.test(e)
        ...
        scrollIntoView: t(function(e, t) {
            ...
            Rr(n = this),
            n.curOp.scrollToPos = t) : zr(this, e.from, e.to, e.margin)
        }),
        ...
        refresh: t(function() {
            ...
            ii(this.display),
            (null == e || .5 < Math.abs(e - ur(this.display)) || this.options.lineWrapping) && pr(this),
            O(this, "refresh", this)
        }),
    ...
    for (Il in f.prototype)
        f.prototype.hasOwnProperty(Il) && L(Bl, Il) < 0 && (p.prototype[Il] = function(e) {
            return function() {
