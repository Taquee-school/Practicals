...
mbr_diagramDiv.appendChild(createImg("practical-file-diagram", "light", physicsFilePath_class12 + "class-12/assets/diagrams/light/meter bridge.jpg"));
mbr_diagramDiv.appendChild(createImg("practical-file-diagram", "dark", physicsFilePath_class12 + "class-12/assets/diagrams/dark/meter bridge.jpg"));
// #endregion Diagram
// #region Objective
let mbr_objectiveDiv = createDiv("practical-section");
experimentDiv.appendChild(mbr_objectiveDiv);
mbr_objectiveDiv.appendChild(createTextField("practical-section-header", "OBJECT:"));
...
mbr_apparatusDiv.appendChild(createTextField("practical-section-header", "APPARATUS USED:"));
...
mbr_formulaDiv.appendChild(createTextField("practical-section-header", "FORMULA USED:"));
...
mbr_formulaDiv.appendChild(createTextField("practical-main-formula", "X = {l/(100-l)}Q"));
...
mbr_formulaBelonging2.appendChild(createTextField(null, "l is the length of wire and"));
...
mbr_observationDiv.appendChild(createTextField("practical-section-header", "OBSERVATION:"));
// #region Meter bridge observations
let mbr_scaleLcInput = createInput("mbr-scale-least-count-input", "number", 0, measureEssentials_mbr);
mbr_observationDiv.appendChild(createPAS("1", createInputDiv("Least count of meter scale:", mbr_scaleLcInput, "cm."), true));
let mbr_wireLengthInput = createInput("mbr-wire-length-input", "number", 0, measureEssentials_mbr);
mbr_observationDiv.appendChild(createPAS("2", createInputDiv("Length of wire:", mbr_wireLengthInput, "cm."), true));
mbr_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of balancing length"));
...
let mbr_sgLeastCountInput = createInput("mbr-sg-lc-input", "number", 0, measureEssentials_mbr);
mbr_observationDiv.appendChild(createPAS("3", createInputDiv("Least count of screw gauge (LC) = Pitch/(no. of circular division) = ", mbr_sgLeastCountInput, "mm"), true));
mbr_observationDiv.appendChild(createPAS("4", createTextField("practical-section-content", "Zero error (e):"), true));
let mbr_zeroErrorDiv = createDiv("moved-div");
mbr_observationDiv.appendChild(mbr_zeroErrorDiv);
let mbr_ze1Input = createInput("mbr-zero-error-1-input", "number", 0, measureEssentials_mbr);
mbr_zeroErrorDiv.appendChild(createPAS("a", createInputDiv("Zero Error: ", mbr_ze1Input, "mm."), true));
let mbr_ze2Input = createInput("mbr-zero-error-2-input", "number", 0, measureEssentials_mbr);
mbr_zeroErrorDiv.appendChild(createPAS("b", createInputDiv("Zero Error: ", mbr_ze2Input, "mm."), true));
let mbr_ze3Input = createInput("mbr-zero-error-3-input", "number", 0, measureEssentials_mbr);
mbr_zeroErrorDiv.appendChild(createPAS("c", createInputDiv("Zero Error: ", mbr_ze3Input, "mm."), true));
let mbr_meanZeroErrorInput = createInput("mbr-sg-mean-ze-input", "number", 0, null, true);
mbr_observationDiv.appendChild(createPAS("5", createInputDiv("Mean zero error = ", mbr_meanZeroErrorInput, "mm."), true));
let mbr_zeroCorrectionInput = createInput("mbr-sg-zc-input", "number", 0, null, true);
mbr_observationDiv.appendChild(createPAS("6", createInputDiv("Zero correction = ", mbr_zeroCorrectionInput, "mm."), true));
mbr_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of diameter of wire"));
...
let mbr_meanDiameterInput = createInput("mbr-sg-mean-d-input", "number", 0, null, true);
mbr_observationDiv.appendChild(createInputDiv("Mean diameter = ", mbr_meanDiameterInput, "cm"));
let mbr_correctedDiameterInput = createInput("mbr-sg-mean-corr-d-input", "number", 0, null, true);
mbr_observationDiv.appendChild(createInputDiv("Mean corrected diameter = ", mbr_correctedDiameterInput, "cm"));
// #endregion Screw gauge observations
// #endregion Observation
// #region Result
let mbr_masspulInput = createInput("mbr-wire-mass-input", "number", 0, null, true);
let mbr_resultDiv = createDiv("practical-section");
experimentDiv.appendChild(mbr_resultDiv);
mbr_resultDiv.appendChild(createTextField("practical-section-header", "RESULT:"));
let mbr_resistanceInput = createInput("mbr-resistance-input", "number", 0);
mbr_resultDiv.appendChild(createPAS("1", createInputDiv("The value of resistance of the given wire is found to be: ", mbr_resistanceInput, "."), true));
let mbr_specificResistanceInput = createInput("mbr-specific-resistance-input", "text", 0);
mbr_specificResistanceInput.style.width = "100px";
mbr_resultDiv.appendChild(createPAS("2", createInputDiv("The value of specific resistance of the material of the wire is found to be: ", mbr_specificResistanceInput, "m."), true));
// #endregion Result
// #region Precautions
let mbr_precautionsDiv = createDiv("practical-section");
experimentDiv.appendChild(mbr_precautionsDiv);
mbr_precautionsDiv.appendChild(createTextField("practical-section-header", "PRECAUTIONS:"));
mbr_precautionsDiv.appendChild(createPAS("1", "The ends of connecting wires should be rubbed and cleaned with a sand paper. The connections should be neat, clean and tight."));
mbr_precautionsDiv.appendChild(createPAS("2", "Plugs in the resistance box should be pressed and tightened by screwing them a little in the clockwise direction."));
mbr_precautionsDiv.appendChild(createPAS("3", "The wire should not be pressed with the jockey too hard otherwise the uniformity of the wire will not be maintained."));
mbr_precautionsDiv.appendChild(createPAS("4", "To avoid any error due to non-uniformity of bridge wire, the balance point should always be obtaied near mid-point."));
mbr_precautionsDiv.appendChild(createPAS("5", "To locate the balance point, the jockey should be lifted and placed on the new position, and should not be slided on the wire."));
mbr_precautionsDiv.appendChild(createPAS("6", "The key of the battery or the cell should be closed first and then the jockey is touched on the wire, when the reading is to be taken."));
...
mbr_soeDiv.appendChild(createTextField("practical-section-header", "SOURCES OF ERRORS:"));
