...
experimentDiv.appendChild(
  createTextField("observation-table-header", "sulphate"),
);
...
ag3_sulphateExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare salt solution, add barium chloride.",
  ),
);
...
ag3_sulphateExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Try to dissolve white precipitate in conc. HCl and HNO3.",
  ),
);
...
ag3_sulphateObservation1Div.appendChild(
...
ag3_sulphateObservation2Div.appendChild(
  createTextField("observation-table-text", "Insoluble in conc. HCl and HNO3."),
);
...
ag3_sulphateInference1Div.appendChild(
  createTextField("observation-table-text", "May be SO4"),
);
...
ag3_sulphateInference2Div.appendChild(
  createTextField("observation-table-text", "SO4 Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(
  createTextField("observation-table-header", "phosphate"),
);
...
ag3_phosphateExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare aqueous solution of salt add 2 ml conc. HNO³ and 2-5 ml ammonium molybdate solution in another test tube. Warm both solution, mix and heat.",
  ),
);
// #endregion Experiment
...
ag3_phosphateObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Formation of canary yellow precipitate.",
  ),
);
// #endregion Observation
...
ag3_phosphateInference1Div.appendChild(
  createTextField("observation-table-text", "PO4 Confirmed"),
);
// #endregion Inference
