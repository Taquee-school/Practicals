...
experimentDiv.appendChild(bg6_reagentDiv);
bg6_reagentDiv.appendChild(
  createTextField("practical-section-text", "Reagent: "),
);
bg6_reagentDiv.appendChild(
  createTextField(
    "practical-section-value",
    "NH4CI + NH4OH + (NH4)2CO3 + Na2HPO4",
  ),
);

// #region magnesium Table
experimentDiv.appendChild(
  createTextField("observation-table-header", "magnesium"),
);

let bg6_magnesiumTable = createDiv("observation-table");
experimentDiv.appendChild(bg6_magnesiumTable);
...
bg6_magnesiumExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Prepare salt solution, add NH4CI, NH4OH, (NH4)2CO3 and Na2HPO4.",
  ),
);
...
bg6_magnesiumObservation1Div.appendChild(
...
bg6_magnesiumInference1Div.appendChild(
  createTextField("observation-table-text", "Mg confirmed"),
);
// #endregion Inference
