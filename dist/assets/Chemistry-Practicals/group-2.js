let basicGroup2Div = createDiv("practical-file", "chemistry-practical");
let bg2_reagentDiv = createDiv("practical-section-text-div");
basicGroup2Div.appendChild(bg2_reagentDiv);
bg2_reagentDiv.appendChild(createTextField("practical-section-text", "Reagent: "));
bg2_reagentDiv.appendChild(createTextField("practical-section-value", "dil. HCl + H2S"));
// #region Lead Table
basicGroup2Div.appendChild(createTextField("observation-table-header", "lead"));
let bg2_leadTable = createDiv("observation-table");
basicGroup2Div.appendChild(bg2_leadTable);
// #region Experiment
...
bg2_leadExperiment1Div.appendChild(createTextField("observation-table-text", "01. Prepare aqueous solution, add dil. HCI and pass H2S gas."));
let bg2_leadExperiment2Div = createDiv("observation-table-inner-div");
bg2_leadExperimentDiv.appendChild(bg2_leadExperiment2Div);
bg2_leadExperiment2Div.appendChild(createTextField("observation-table-text", "02. Dissolve the precipitate in 50% nitric acid and divide in the two parts."));
let bg2_leadExperiment3Div = createDiv("observation-table-inner-div");
bg2_leadExperimentDiv.appendChild(bg2_leadExperiment3Div);
bg2_leadExperiment3Div.appendChild(createTextField("observation-table-text", "a) To the first portion add potassium chromate solution."));
let bg2_leadExperiment4Div = createDiv("observation-table-inner-div");
bg2_leadExperimentDiv.appendChild(bg2_leadExperiment4Div);
bg2_leadExperiment4Div.appendChild(createTextField("observation-table-text", "b) To the second portion add potassium iodide solution."));
...
bg2_leadObservation1Div.appendChild(createTextField("observation-table-text", "Formation of black precipitate."));
...
bg2_leadObservation2Div.appendChild(createTextField("observation-table-text", "Colourless clear solution."));
...
bg2_leadObservation3Div.appendChild(createTextField("observation-table-text", "Formation of yellow precipitate."));
...
bg2_leadObservation4Div.appendChild(createTextField("observation-table-text", "Formation of orange precipitate."));
...
bg2_leadInference1Div.appendChild(createTextField("observation-table-text", "May be Pb2+,Cu2+"));
let bg2_leadInference2Div = createDiv("observation-table-inner-div");
bg2_leadInferenceDiv.appendChild(bg2_leadInference2Div);
bg2_leadInference2Div.appendChild(createTextField("observation-table-text", "May be Pb2+"));
let bg2_leadInference3Div = createDiv("observation-table-inner-div");
bg2_leadInferenceDiv.appendChild(bg2_leadInference3Div);
bg2_leadInference3Div.appendChild(createTextField("observation-table-text", "Pb2+ Confirmed"));
let bg2_leadInference4Div = createDiv("observation-table-inner-div");
bg2_leadInferenceDiv.appendChild(bg2_leadInference4Div);
bg2_leadInference4Div.appendChild(createTextField("observation-table-text", "Pb2+ Confirmed"));
// #endregion Inference
// #endregion lead Table
// #region Copper Table
basicGroup2Div.appendChild(createTextField("observation-table-header", "copper"));
let bg2_copperTable = createDiv("observation-table");
basicGroup2Div.appendChild(bg2_copperTable);
// #region Experiment
...
bg2_copperExperiment1Div.appendChild(createTextField("observation-table-text", "01. Prepare aqueous solution, add dil. HCI and pass H2S gas."));
...
bg2_copperExperiment2Div.appendChild(createTextField("observation-table-text", "02. Dissolve the precipitate in 50% nitric acid and divide in the two parts."));
...
bg2_copperExperiment3Div.appendChild(createTextField("observation-table-text", "a) To the first part add NH4OH."));
...
bg2_copperExperiment4Div.appendChild(createTextField("observation-table-text", "b) To the second part add acetic acid and K3[Fe(CN)6] (potassium Ferrocyanide)."));
// #endregion Experiment
// #region Observation
...
bg2_copperObservation1Div.appendChild(createTextField("observation-table-text", "Formation of black precipitate."));
...
bg2_copperObservation2Div.appendChild(createTextField("observation-table-text", "Formation of bluish green solution."));
...
bg2_copperObservation3Div.appendChild(createTextField("observation-table-text", "Formation of deep blue solution."));
...
bg2_copperObservation4Div.appendChild(createTextField("observation-table-text", "Chocolate color precipitate."));
// #endregion Observation
// #region Inference
...
bg2_copperInference1Div.appendChild(createTextField("observation-table-text", "May be Cu2+, Pb2+"));
...
bg2_copperInference2Div.appendChild(createTextField("observation-table-text", "May be Cu2+"));
...
bg2_copperInference3Div.appendChild(createTextField("observation-table-text", "Cu2+ Confirmed"));
...
bg2_copperInference4Div.appendChild(createTextField("observation-table-text", "Cu2+ Confirmed"));
// #endregion Inference
// #endregion copper Table
// #region Cadmium Table
basicGroup2Div.appendChild(createTextField("observation-table-header", "cadmium"));
let bg2_cadmiumTable = createDiv("observation-table");
basicGroup2Div.appendChild(bg2_cadmiumTable);
// #region Experiment
...
bg2_cadmiumExperiment1Div.appendChild(createTextField("observation-table-text", "01. Prepare aqueous solution, add dil. HCI and pass H2S gas."));
...
bg2_cadmiumExperiment2Div.appendChild(createTextField("observation-table-text", "02. Dissolve the yellow precipitate in dil. HCI add sodium hydroxide solution."));
// #endregion Experiment
// #region Observation
...
bg2_cadmiumObservation1Div.appendChild(createTextField("observation-table-text", "Formation of yellow precipitate"));
...
bg2_cadmiumObservation2Div.appendChild(createTextField("observation-table-text", "Formation of white precipitate"));
// #endregion Observation
// #region Inference
...
bg2_cadmiumInference1Div.appendChild(createTextField("observation-table-text", "May be Cd2+"));
...
bg2_cadmiumInference2Div.appendChild(createTextField("observation-table-text", "Cd2+ Confirmed"));
export {};
// #endregion Inference
// #endregion cadmium Table
//# sourceMappingURL=group-2.js.map