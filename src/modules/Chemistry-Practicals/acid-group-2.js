...
ag2_reagentDiv.appendChild(
  createTextField("practical-section-text", "Reagent: "),
);
ag2_reagentDiv.appendChild(
  createTextField("practical-section-value", "Conc. H2SO4"),
);

// #region Chloride Table
experimentDiv.appendChild(
  createTextField("observation-table-header", "chloride"),
);
...
ag2_chlorideExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add conc. H2SO4.",
  ),
);
...
ag2_chlorideExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Take a pinch of salt in another dry test tube, add H2SO4 and bring a glass rod dipped in ammonium hydroxide solution.",
  ),
);
...
ag2_chlorideExperiment3Div.appendChild(
  createTextField(
    "observation-table-text",
    "03. Take 0.5 gm salt, add K2Cr2O7 in a dry test tube and add conc. H2SO4 heat pass the evolved gas through water with the help of a delivery tube. Add acetic acid and lead acetate solution in the yellow water.",
  ),
);
...
ag2_chlorideObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Evolution of colourless gas with pungent smell.",
  ),
);
...
ag2_chlorideObservation2Div.appendChild(
  createTextField("observation-table-text", "Formation of white dense fumes."),
);
...
ag2_chlorideObservation3Div.appendChild(
...
ag2_chlorideInference1Div.appendChild(
  createTextField("observation-table-text", "May be Cl"),
);
...
ag2_chlorideInference2Div.appendChild(
  createTextField("observation-table-text", "May be Cl"),
);
...
ag2_chlorideInference3Div.appendChild(
  createTextField("observation-table-text", "Cl Confirmed"),
);
// #endregion Inference
...
experimentDiv.appendChild(
  createTextField("observation-table-header", "bromide"),
);
...
ag2_bromideExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add conc. H2SO4.",
  ),
...
ag2_bromideExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Prepare aqueous solution, add CCl⁴(2-5 ml), acetic acid(1 ml) and Cl² water shake the test tube.",
  ),
);
// #endregion Experiment
...
ag2_bromideObservation1Div.appendChild(
  createTextField("observation-table-text", "Evolution of brown fumes."),
);
...
ag2_bromideObservation2Div.appendChild(
  createTextField(
    "observation-table-text",
    "Lower organic layer(CCl4 layer) turns brown.",
  ),
);
// #endregion Observation
...
ag2_bromideInference1Div.appendChild(
  createTextField("observation-table-text", "May be Br"),
);
...
ag2_bromideInference2Div.appendChild(
  createTextField("observation-table-text", "Br Confirmed"),
);
// #endregion Inference
...
ag2_nitrateExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add conc. H2SO4.",
  ),
...
ag2_nitrateExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Prepare aqueous solution, add freshly prepared FeSO4 and conc. H2SO4.",
  ),
);
// #endregion Experiment
...
ag2_nitrateObservation1Div.appendChild(
  createTextField("observation-table-text", "Evolution of brown fumes."),
);
...
ag2_nitrateObservation2Div.appendChild(
  createTextField(
    "observation-table-text",
    "Formation of brown rings at the junction of layers.",
  ),
);
// #endregion Observation
...
ag2_nitrateInference1Div.appendChild(
  createTextField("observation-table-text", "May be NO"),
);
...
ag2_nitrateInference2Div.appendChild(
  createTextField("observation-table-text", "NO Confirmed"),
);
// #endregion Inference
...
// #region Iodide Table
experimentDiv.appendChild(
  createTextField("observation-table-header", "iodide"),
);
...
ag2_iodideExperiment1Div.appendChild(
  createTextField(
    "observation-table-text",
    "01. Take a pinch of salt in a dry test tube, add conc. H2SO4.",
  ),
...
ag2_iodideExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
    "02. Prepare aqueous solution, add CCl4(2-5 ml), acetic acid(1 ml) and Cl2 water and shake the test tube.",
  ),
);
// #endregion Experiment
...
ag2_iodideObservation1Div.appendChild(
  createTextField(
    "observation-table-text",
    "Evolution of violet or purple colour gas.",
  ),
);
...
ag2_iodideObservation2Div.appendChild(
  createTextField(
    "observation-table-text",
    "Lower organic layer(CCl4 layer) turns purple.",
  ),
);
// #endregion Observation
...
ag2_iodideInference1Div.appendChild(
  createTextField("observation-table-text", "May be I"),
);
...
ag2_iodideInference2Div.appendChild(
  createTextField("observation-table-text", "I Confirmed"),
);
// #endregion Inference
