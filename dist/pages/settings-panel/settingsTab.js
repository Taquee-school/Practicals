...
navBarStylePanelContent.appendChild(toggleEffect(createButton("sticky-btn-navigation-bar", "radio-option toggle-effect selected", stickyIcon, "Sticky", () => {
...
navBarStylePanelContent.appendChild(toggleEffect(createButton("floating-btn-navigation-bar", "radio-option toggle-effect", floatingIcon, "Floating", () => {
...
navBarStylePanelContent.appendChild(toggleEffect(createButton("hidden-btn-navigation-bar", "radio-option toggle-effect", hiddenIcon, "Hidden", () => {
...
palettePanelContent.appendChild(toggleEffect(createButton("default-btn-palette", "radio-option selected toggle-effect", defaultIcon, "Default", () => {
    choosePalette("default", palettePanelContent.querySelector("#default-btn-palette"));
})));
const limeIcon = createIcon("bold", "circle");
palettePanelContent.appendChild(toggleEffect(createButton("lime-btn-palette", "radio-option toggle-effect", limeIcon, "Lime", () => {
    choosePalette("lime", palettePanelContent.querySelector("#lime-btn-palette"));
})));
const purpleIcon = createIcon("bold", "circle");
palettePanelContent.appendChild(toggleEffect(createButton("purple-btn-palette", "radio-option toggle-effect", purpleIcon, "Purple", () => {
    choosePalette("purple", palettePanelContent.querySelector("#purple-btn-palette"));
})));
const pinkIcon = createIcon("bold", "circle");
palettePanelContent.appendChild(toggleEffect(createButton("pink-btn-palette", "radio-option toggle-effect", pinkIcon, "Pink", () => {
    choosePalette("pink", palettePanelContent.querySelector("#pink-btn-palette"));
})));
const blueIcon = createIcon("bold", "circle");
palettePanelContent.appendChild(toggleEffect(createButton("blue-btn-palette", "radio-option toggle-effect", blueIcon, "Blue", () => {
