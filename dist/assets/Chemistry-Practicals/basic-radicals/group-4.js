let basicGroup4Div = createDiv("practical-file", "chemistry-practical");
let bg4_reagentDiv = createDiv("practical-section-text-div");
basicGroup4Div.appendChild(bg4_reagentDiv);
bg4_reagentDiv.appendChild(createTextField("practical-section-text", "Reagent: "));
bg4_reagentDiv.appendChild(createTextField("practical-section-value", "NH4Cl + NH4OH + H2S"));
// #region zinc Table
basicGroup4Div.appendChild(createTextField("observation-table-header", "zinc"));
let bg4_zincTable = createDiv("observation-table");
basicGroup4Div.appendChild(bg4_zincTable);
// #region Experiment
...
bg4_zincExperiment1Div.appendChild(createTextField("observation-table-text", "01. Prepare salt solution, add NH4Cl, NH4OH and pass H2S."));
let bg4_zincExperiment2Div = createDiv("observation-table-inner-div");
bg4_zincExperimentDiv.appendChild(bg4_zincExperiment2Div);
bg4_zincExperiment2Div.appendChild(createTextField("observation-table-text", "02. Dissolve the precipitate in dil. HCl and NaOH."));
...
bg4_zincObservation1Div.appendChild(createTextField("observation-table-text", "Dirty white precipitate."));
...
bg4_zincObservation2Div.appendChild(createTextField("observation-table-text", "Formation of white precipitate."));
...
bg4_zincInference1Div.appendChild(createTextField("observation-table-text", "May be Zn"));
let bg4_zincInference2Div = createDiv("observation-table-inner-div");
bg4_zincInferenceDiv.appendChild(bg4_zincInference2Div);
bg4_zincInference2Div.appendChild(createTextField("observation-table-text", "Zn Confirmed"));
// #endregion Inference
// #endregion zinc Table
// #region manganese Table
basicGroup4Div.appendChild(createTextField("observation-table-header", "manganese"));
let bg4_manganeseTable = createDiv("observation-table");
basicGroup4Div.appendChild(bg4_manganeseTable);
// #region Experiment
...
bg4_manganeseExperiment1Div.appendChild(createTextField("observation-table-text", "01. Prepare salt solution, add NH4Cl, NH4OH and pass H2S."));
...
bg4_manganeseExperiment2Div.appendChild(createTextField("observation-table-text", "02. Dissolve the precipitate in dil. HCl and NaOH."));
// #endregion Experiment
// #region Observation
...
bg4_manganeseObservation1Div.appendChild(createTextField("observation-table-text", "Brown or buff colour precipitate."));
...
bg4_manganeseObservation2Div.appendChild(createTextField("observation-table-text", "White precipitate which turns brown on exposure to the atmosphere."));
// #endregion Observation
// #region Inference
...
bg4_manganeseInference1Div.appendChild(createTextField("observation-table-text", "May be Mn"));
...
bg4_manganeseInference2Div.appendChild(createTextField("observation-table-text", "Mn Confirmed"));
// #endregion Inference
// #endregion manganese Table
// #region nickelCobalt Table
basicGroup4Div.appendChild(createTextField("observation-table-header", "Nickel & Cobalt"));
let bg4_nickelCobaltTable = createDiv("observation-table");
basicGroup4Div.appendChild(bg4_nickelCobaltTable);
// #region Experiment
...
bg4_nickelCobaltExperiment1Div.appendChild(createTextField("observation-table-text", "01. Prepare salt solution, add NH4Cl, NH4OH and pass H2S."));
...
bg4_nickelCobaltExperiment2Div.appendChild(createTextField("observation-table-text", "02. Dissolve the black precipitates in aqua regia, evaporate to dryness cool and add water, divide in two parts."));
...
bg4_nickelCobaltExperiment3Div.appendChild(createTextField("observation-table-text", "a) To the first part add (2-5m) Dimethylglyoxime and NH⁴OH Solution."));
...
bg4_nickelCobaltExperiment4Div.appendChild(createTextField("observation-table-text", "b) If Ni is absent. To the second part add 1 ml amyl alcohol and add ammonium sulphocyanide."));
// #endregion Experiment
// #region Observation
...
bg4_nickelCobaltObservation1Div.appendChild(createTextField("observation-table-text", "Formation of black colour precipitate."));
...
bg4_nickelCobaltObservation2Div.appendChild(createTextField("observation-table-text", ""));
...
bg4_nickelCobaltObservation3Div.appendChild(createTextField("observation-table-text", "Formation of pink color precipitate."));
...
bg4_nickelCobaltObservation4Div.appendChild(createTextField("observation-table-text", "Deep blue colour in alcoholic layer."));
// #endregion Observation
// #region Inference
...
bg4_nickelCobaltInference1Div.appendChild(createTextField("observation-table-text", "May be Ni or Co"));
...
bg4_nickelCobaltInference2Div.appendChild(createTextField("observation-table-text", ""));
...
bg4_nickelCobaltInference3Div.appendChild(createTextField("observation-table-text", "Ni confirmed"));
...
bg4_nickelCobaltInference4Div.appendChild(createTextField("observation-table-text", "Cu confirmed"));
export {};
// #endregion Inference
// #endregion nickelCobalt Table
//# sourceMappingURL=group-4.js.map