...
let convexLensDiv = document.createElement("div");
convexLensDiv.className = "practical-file";

let cvl_objectiveDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_objectiveDiv);
cvl_objectiveDiv.className = "practical-section";
...
let cvl_apparatusDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_apparatusDiv);
cvl_apparatusDiv.className = "practical-section";
...
let cvl_formulaDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_formulaDiv);
cvl_formulaDiv.className = "practical-section";
...
let cvl_observationDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_observationDiv);
cvl_observationDiv.className = "practical-section";
...
let cvl_distanceTableDiv = document.createElement("div");
cvl_distanceTableDiv.className = "observation-table-div";
cvl_observationDiv.appendChild(cvl_distanceTableDiv);

let cvl_distanceTable = document.createElement("div");
cvl_distanceTable.className = "observation-table";
...
let cvl_resultDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_resultDiv);
cvl_resultDiv.className = "practical-section";
...
let cvl_precautionsDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_precautionsDiv);
cvl_precautionsDiv.className = "practical-section";
...
let cvl_SOEDiv = document.createElement("div");
convexLensDiv.appendChild(cvl_SOEDiv);
cvl_SOEDiv.className = "practical-section";
