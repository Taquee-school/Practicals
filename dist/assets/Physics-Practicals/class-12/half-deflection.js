...
hdf_objectiveDiv.appendChild(createTextField("practical-section-header", "OBJECT:"));
hdf_objectiveDiv.appendChild(createTextField("practical-section-content", "To study the current and voltage relationship (Ohm's Law) using an ammeter and voltmeter."));
// #endregion Objective
// #region Apparatus
let hdf_apparatusDiv = createDiv("practical-section");
experimentDiv.appendChild(hdf_apparatusDiv);
hdf_apparatusDiv.appendChild(createTextField("practical-section-header", "APPARATUS USED:"));
hdf_apparatusDiv.appendChild(createTextField("practical-section-content", "Resistance coils, a battery eliminator(0-3 V), DC voltmeter(range: 3V), DC ammeter(range: 500mA), a rheostat one plug key, thick connecting wires, sand paper, etc."));
// #endregion Apparatus
// #region Formula
let hdf_formulaDiv = createDiv("practical-section");
experimentDiv.appendChild(hdf_formulaDiv);
hdf_formulaDiv.appendChild(createTextField("practical-section-header", "FORMULA USED:"));
hdf_formulaDiv.appendChild(createTextField("practical-section-content", "Ohm's law states that the ratio of potential difference between any two points of a conductor to the electric current flowing through it is constant, provided the physical conditions namely temperature, pressure,etc. remains constant."));
hdf_formulaDiv.appendChild(createTextField("practical-main-formula", "G = RS/(R-S)"));
hdf_formulaDiv.appendChild(createTextField("practical-section-content", "R Is the resistance in series with galvanometer and shunt resistance is S."));
// #endregion Formula
// #region Observation
let hdf_observationDiv = createDiv("practical-section");
experimentDiv.appendChild(hdf_observationDiv);
hdf_observationDiv.appendChild(createTextField("practical-section-header", "OBSERVATION:"));
...
hdf_resultDiv.appendChild(createTextField("practical-section-header", "RESULT:"));
let hdf_resistanceInput = createInput("hdf-mass-per-unit-length-input", "number", 0);
hdf_resultDiv.appendChild(createPAS("1", createInputDiv("Resistance of galvanometer(G) by half deflection method is found to be ", hdf_resistanceInput, "."), true));
// #endregion Result
// #region Precautions
let hdf_precautionsDiv = createDiv("practical-section");
experimentDiv.appendChild(hdf_precautionsDiv);
hdf_precautionsDiv.appendChild(createTextField("practical-section-header", "PRECAUTIONS:"));
hdf_precautionsDiv.appendChild(createPAS("1", "That resistance connection should be neat and tight."));
hdf_precautionsDiv.appendChild(createPAS("2", "The battery key should be closed to avoid any damage in the galvanometer."));
hdf_precautionsDiv.appendChild(createPAS("3", "Deflection in the galvanometer should be as large as possible."));
hdf_precautionsDiv.appendChild(createPAS("4", "The value of R must be very large as compared to the value of G."));
hdf_precautionsDiv.appendChild(createPAS("5", "EMF of the battery eliminator should also be constant."));
...
hdf_soeDiv.appendChild(createTextField("practical-section-header", "SOURCES OF ERRORS:"));
hdf_soeDiv.appendChild(createPAS("1", "The distance of the wire in the resistance box may not exactly be the same as marked."));
hdf_soeDiv.appendChild(createPAS("2", "The plug in the resistance box may be loose which will provide large errors in observation."));
hdf_soeDiv.appendChild(createPAS("3", "The EMF of the battery may not be constant."));
// #endregion Sources of Errors
// #region Functions
//# sourceMappingURL=half-deflection.js.map