...
function createInput(id, type, value = 0, inputFunction = null, readOnly = false) {
...
function createColumn(header, numberOfRows, idPattern, type, value, inputFunction, readOnly = false) {
    let column = document.createElement("div");
    column.className = "observation-table-column";
    let columnHeader = document.createElement("div");
    columnHeader.className = "observation-table-column-header";
...
export {};
//# sourceMappingURL=physicsPracticals.js.map