...
ohl_diagramDiv.appendChild(createImg("practical-file-diagram", "light", physicsFilePath_class12 + "class-12/assets/diagrams/light/ohms law.jpg"));
ohl_diagramDiv.appendChild(createImg("practical-file-diagram", "dark", physicsFilePath_class12 + "class-12/assets/diagrams/dark/ohms law.jpg"));
// #endregion Diagram
// #region Objective
...
ohl_objectiveDiv.appendChild(createTextField("practical-section-content", "To study the current and voltage relationship (Ohm's Law) using an ammeter and voltmeter."));
// #endregion Objective
// #region Apparatus
let ohl_apparatusDiv = createDiv("practical-section");
experimentDiv.appendChild(ohl_apparatusDiv);
ohl_apparatusDiv.appendChild(createTextField("practical-section-header", "APPARATUS USED:"));
ohl_apparatusDiv.appendChild(createTextField("practical-section-content", "Resistance coils, a battery eliminator(0-3 V), DC voltmeter(range: 3V), DC ammeter(range: 500mA), a rheostat one plug key, thick connecting wires, sand paper, etc."));
// #endregion Apparatus
// #region Formula
let ohl_formulaDiv = createDiv("practical-section");
experimentDiv.appendChild(ohl_formulaDiv);
ohl_formulaDiv.appendChild(createTextField("practical-section-header", "FORMULA USED:"));
ohl_formulaDiv.appendChild(createTextField("practical-section-content", "Ohm's law states that the ratio of potential difference between any two points of a conductor to the electric current flowing through it is constant, provided the physical conditions namely temperature, pressure,etc. remains constant."));
ohl_formulaDiv.appendChild(createTextField("practical-main-formula", "V/I = constant = R"));
// #endregion Formula
// #region Observation
let ohl_observationDiv = createDiv("practical-section");
experimentDiv.appendChild(ohl_observationDiv);
ohl_observationDiv.appendChild(createTextField("practical-section-header", "OBSERVATION:"));
...
let ohl_ammeterRangeInput = createInput("ohl-ammeter-range-input", "number", 0, measureEssentials_ohl);
ohl_rangeObservationDiv.appendChild(createInputDiv("Milli-ammeter: ", ohl_ammeterRangeInput, "mA"));
let ohl_voltmeterRangeInput = createInput("ohl-voltmeter-range-input", "number", 0, measureEssentials_ohl);
ohl_rangeObservationDiv.appendChild(createInputDiv("Voltmeter: ", ohl_voltmeterRangeInput, "V"));
...
let ohl_ammeterLcInput = createInput("ohl-ammeter-least-count-input", "number", 0, measureEssentials_ohl);
ohl_leastCountObservationDiv.appendChild(createInputDiv("Milli-ammeter: ", ohl_ammeterLcInput, "mA"));
let ohl_voltmeterLcInput = createInput("ohl-voltmeter-least-count-input", "number", 0, measureEssentials_ohl);
ohl_leastCountObservationDiv.appendChild(createInputDiv("Voltmeter: ", ohl_voltmeterLcInput, "V"));
ohl_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of resistance of wire"));
...
ohl_resultDiv.appendChild(createTextField("practical-section-header", "RESULT:"));
ohl_resultDiv.appendChild(createPAS("1", "Graph between potential drop V and the current through the conductor I is a straight line."));
let ohl_resistanceInput = createInput("ohl-resistance-input", "number", 0, null, true);
ohl_resultDiv.appendChild(createPAS("2", createInputDiv("The value of the given resistance is found to be: ", ohl_resistanceInput, "Ω"), true));
// #endregion Result
// #region Precautions
let ohl_precautionsDiv = createDiv("practical-section");
experimentDiv.appendChild(ohl_precautionsDiv);
ohl_precautionsDiv.appendChild(createTextField("practical-section-header", "PRECAUTIONS:"));
ohl_precautionsDiv.appendChild(createPAS("1", "The ends of the wire should be neat and clean."));
ohl_precautionsDiv.appendChild(createPAS("2", "The connection should be tight."));
ohl_precautionsDiv.appendChild(createPAS("3", "The current passed should not be high and it should be passed for a short interval of time."));
ohl_precautionsDiv.appendChild(createPAS("4", "The voltmeter should be connected in parallel and the ammeter in series and these should be so connected that the current enters at the positive terminal and leaves at the negative terminal."));
ohl_precautionsDiv.appendChild(createPAS("5", "The connecting wires used should be thick copper wires and the insulation of their ends should be removed by rubbing them with sandpaper."));
ohl_precautionsDiv.appendChild(createPAS("6", "Before plugging in the key, it should be ensured that the circuit and connections are right."));
ohl_precautionsDiv.appendChild(createPAS("7", "The plug should be inserted only while taking observations, otherwise current would cause unnecessary heating in the circuit."));
ohl_precautionsDiv.appendChild(createPAS("8", "Measuring instruments of appropriate ranges should be used and zero error in them if any must be taken into account."));
...
ohmsLaw_soeDiv.appendChild(createTextField("practical-section-header", "SOURCES OF ERRORS:"));
ohmsLaw_soeDiv.appendChild(createPAS("1", "The connection may be loose."));
ohmsLaw_soeDiv.appendChild(createPAS("2", "The ratio of V/I may not be constant due to heating caused by passage of current for a longer interval of time."));
ohmsLaw_soeDiv.appendChild(createPAS("3", "The wire may not have uniform thickness."));
// #endregion Sources of Errors
//# sourceMappingURL=ohms-law.js.map