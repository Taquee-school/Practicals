...
cvl_objectiveDiv.appendChild(createTextField("practical-section-header", "OBJECT:"));
cvl_objectiveDiv.appendChild(createTextField("practical-section-content", "To find the value of 'v' for different values of 'u' in case of a convex lens and hence, to find the focal length 'f' of the lens by plotting a graph between 'u'& 'v'."));
// #endregion Objective
// #region Apparatus
let cvl_apparatusDiv = createDiv("practical-section");
experimentDiv.appendChild(cvl_apparatusDiv);
cvl_apparatusDiv.appendChild(createTextField("practical-section-header", "APPARATUS USED:"));
cvl_apparatusDiv.appendChild(createTextField("practical-section-content", "An optical bench along with three uprights, one lens holder, two needles, convex lens, a knitting needle and a meter scale."));
// #endregion Apparatus
// #region Formula
let cvl_formulaDiv = createDiv("practical-section");
experimentDiv.appendChild(cvl_formulaDiv);
cvl_formulaDiv.appendChild(createTextField("practical-section-header", "FORMULA USED:"));
cvl_formulaDiv.appendChild(createTextField("practical-section-content", "The relation between the object distance u, the image distance v and the focal length f of a lens (here for convex lens) is given by,"));
cvl_formulaDiv.appendChild(createTextField("practical-main-formula", "1/f = 1/v - 1/u"));
cvl_formulaDiv.appendChild(createTextField("practical-section-content", "Where,"));
// #endregion Formula
// #region Observation
let cvl_observationDiv = createDiv("practical-section");
experimentDiv.appendChild(cvl_observationDiv);
cvl_observationDiv.appendChild(createTextField("practical-section-header", "OBSERVATION:"));
let cvl_lengthOfNeedleInput = createInput("cvl-length-of-knitting-needle-input", "number", 0, measureEssentials_cvl);
cvl_observationDiv.appendChild(createPAS("1", createInputDiv("Length of knitting needle (x): ", cvl_lengthOfNeedleInput, "cm."), true));
let cvl_distanceLensObjectInput = createInput("cvl-distance-between-Lens-and-object-input", "number", 0, measureEssentials_cvl);
cvl_observationDiv.appendChild(createPAS("2", createInputDiv("Observed distance between the Lens and the object needle 'O' when the Knitting needle is introduced between them (y): ", cvl_distanceLensObjectInput, "cm."), true));
let cvl_distanceLensImageInput = createInput("cvl-distance-between-Lens-and-image-input", "number", 0, measureEssentials_cvl);
cvl_observationDiv.appendChild(createPAS("3", createInputDiv("Observed distance between the Lens and the iamge needle 'I' when the Knitting needle is introduced between them (z): ", cvl_distanceLensImageInput, "cm."), true));
let cvl_indexErrorUInput = createInput("cvl-index-error-u-input", "number", 0, null, true);
cvl_observationDiv.appendChild(createPAS("4", createInputDiv("Index error for 'u' = e1 = (y-x) :", cvl_indexErrorUInput, "cm."), true));
let cvl_indexCorrectionUInput = createInput("cvl-index-correction-u-input", "number", 0, null, true);
cvl_observationDiv.appendChild(createPAS("5", createInputDiv("Index correction for 'u' = (-e1) :", cvl_indexCorrectionUInput, "cm."), true));
let cvl_indexErrorVInput = createInput("cvl-index-error-v-input", "number", 0, null, true);
cvl_observationDiv.appendChild(createPAS("6", createInputDiv("Index error for 'v' = e2 = (z-x) :", cvl_indexErrorVInput, "cm."), true));
let cvl_indexCorrectionVInput = createInput("cvl-index-correction-v-input", "number", 0, null, true);
cvl_observationDiv.appendChild(createPAS("7", createInputDiv("Index correction for 'v' = (-e2) :", cvl_indexCorrectionVInput, "cm."), true));
cvl_observationDiv.appendChild(createTextField("observation-table-header", "Table for the measurement of focal length of mirror"));
...
cvl_resultDiv.appendChild(createTextField("practical-section-header", "RESULT:"));
let cvl_focalLengthCalculatedInput = createInput("cvl-mean-focal-length-calculated-input", "number", 0);
cvl_resultDiv.appendChild(createPAS("1", createInputDiv("Mean value of focal length by computations found to be: ", cvl_focalLengthCalculatedInput, "cm."), true));
let cvl_focalLengthGraphInput = createInput("cvl-mean-focal-length-by-graph-input", "number", 0);
cvl_resultDiv.appendChild(createPAS("2", createInputDiv("The focal length of the given convex Lens as determined by plotting graph(Hyperbola) between 'u' and 'v' is found to be: ", cvl_focalLengthGraphInput, "cm."), true));
// #endregion Result
// #region Precautions
let cvl_precautionsDiv = createDiv("practical-section");
experimentDiv.appendChild(cvl_precautionsDiv);
cvl_precautionsDiv.appendChild(createTextField("practical-section-header", "PRECAUTIONS:"));
...
experimentDiv.appendChild(cvl_SOEDiv);
// #endregion Precautions
// #region Sources of Errors
cvl_SOEDiv.appendChild(createTextField("practical-section-header", "SOURCES OF ERRORS:"));
...
//# sourceMappingURL=convex-lens.js.map