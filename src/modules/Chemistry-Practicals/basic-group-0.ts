...
experimentDiv.appendChild(
  createTextField("observation-table-header", "Ammonium"),
);
...
bg0_ammoniumExperiment1Div.appendChild(
  createTextField(
...
bg0_ammoniumExperiment2Div.appendChild(
  createTextField(
    "observation-table-text",
...
bg0_ammoniumObservation1Div.appendChild(
...
bg0_ammoniumObservation2Div.appendChild(
...
bg0_ammoniumInference1Div.appendChild(
...
bg0_ammoniumInference2Div.appendChild(
